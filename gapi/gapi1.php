...
$ga->requestReportData(ga_profile_id,array('year','month','country'),array('visits'));
...
$ga->requestReportData(ga_profile_id,array('source'),array('visits'),'','',$fml);
...
$fml = date('Y-m-d', strtotime("-4 months"));
$ga->requestReportData(ga_profile_id,array('userType'),array('visits'),'','',$fml);
...
$ga->requestReportData(ga_profile_id,array('mobileDeviceInfo'),array('visits'),'','',$fml);
