...
AmCharts.AmChart = AmCharts.Class({
    ...
    drawChart: function () {
        ...
        if (a = this.backgroundImage) this.path && (a = this.path + a), this.bgImg = b = b.image(a, 0, 0, e, f), this.set.push(b);
        this.drawTitles()
    },
    drawTitles: function () {
        var a = this.titles;
    ...
    write: function (a) {
        ...
        case "right":
            ...
            break;
        case "left":
            c.style.position = "relative", b.style.position = "absolute", a.appendChild(b), a.appendChild(c)
    ...
    drawLabel: function (a) {
        var b = a.x,
            ...
            j = a.alpha,
            l = a.bold;
        this.container && (a = AmCharts.toCoordinate(b, this.realWidth), c = AmCharts.toCoordinate(c, this.realHeight), a || (a = 0), c || (c = 0), void 0 == g && (g = this.color), isNaN(f) && (f = this.fontSize), e || (e = "start"), "left" == e && (e = "start"), "right" == e && (e = "end"), "center" == e && (e = "middle", h ? c = this.realHeight - c + c / 2 : a = this.realWidth / 2 - a), void 0 == j && (j = 1), void 0 == h && (h = 0), a = AmCharts.text(this.container, a, c + f / 2, d, {
            fill: g,
            "fill-opacity": j,
            "text-anchor": e,
            "font-family": this.fontFamily,
    ...
    updateWidth: function () {
        ...
        if (c) {
            var d = Number(this.legendDiv.style.width.replace("px", "")),
                ...
                c = c.position;
            if ("right" == c || "left" == c) a -= d, 0 > a && (a = 0), this.chartDiv.style.width = a + "px", "left" == c ? this.chartDiv.style.left = AmCharts.findPosX(this.div) + d + "px" : this.legendDiv.style.left = a + "px", this.legendDiv.style.top = (b - e) / 2 + "px"
        }
        return a
    },
    ...
    invalidateSize: function () {
        this.measure();
        if ((this.realWidth != this.previousWidth || this.realHeight != this.previousHeight) && this.chartCreated) this.legend && this.legend.invalidateSize(), this.initChart()
    },
    ...
    showBalloon: function (a, b, c, d, e) {
        ...
        this.balloon.enabled && (this.balloon.followCursor(!1), this.balloon.changeColor(b), c || this.balloon.setPosition(d, e), this.balloon.followCursor(c),
        a && this.balloon.showBalloon(a))
    },
...
AmCharts.resetDateToMin = function (a, b, c, d) {
    ...
    case "ss":
        ...
        break;
    case "fff":
        e = a.getFullYear(), f = a.getMonth(), g = a.getDate(), h = a.getHours(), j = a.getMinutes(), l = a.getSeconds(), k = Math.floor(a.getMilliseconds() / c) * c
    }
...
AmCharts.Cuboid = AmCharts.Class({
    ...
    draw: function () {
        ...
        if (0 < e || 0 < f) {
            ...
            m = AmCharts.polygon(b, [0, e, c + e, c, 0], [0, f, f, 0, 0], [m], h, 0, 0, 0, n);
            a.push(m);
            m = AmCharts.line(b, [0, e, c + e], [0, f, f], l, k, j);
            a.push(m);
            ...
            if (0 < d && 0 < c) {
                ...
                a.push(p);
                p.translate(e, - d + f);
                p = AmCharts.line(b, [e, e], [f, - d + f], l, k, j);
                a.push(p);
                p = AmCharts.polygon(b, [0,
                0, e, e, 0], [0, - d, - d + f, f, 0], m, h, 0, 0, 0, n);
                a.push(p);
                m = AmCharts.polygon(b, [0, 0, e, e, 0], [0, - d, - d + f, f, 0], m, h, 0, 0, 0, n);
                m.translate(c, 0);
                a.push(m);
                m = AmCharts.line(b, [0, e, e, 0], [-d, - d + f, f, 0], l, k, j);
                a.push(m);
                m.translate(c, 0)
            }
            m = g[0];
            ...
            m.translate(0, - d);
            a.push(m);
            e = AmCharts.line(b, [0, e, c + e], [0, f, f], l, k, j);
            e.translate(0, - d);
            a.push(e)
        }
        1 > d && (d = 1, k = h = 0);
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    drawLegend: function () {
        var a = this.chart,
            ...
            f = this.div,
            g = this.data;
        "right" == b || "left" == b ? (this.maxColumns = 1, this.marginLeft = this.marginRight = 10) : this.autoMargins && (this.marginRight = a.marginRight, this.marginLeft = a.marginLeft, "bottom" == b ? (this.marginBottom = a.autoMarginOffset, this.marginTop = 0) : (this.marginTop = a.autoMarginOffset, this.marginBottom = 0));
        ...
        this.titleWidth = 0;
        if (e = this.title) f = a.fontSize, this.titleWidth = AmCharts.text(this.container, 0, this.marginTop + f / 2 + this.ly, e, {
            fill: this.color,
            "text-anchor": "start",
            "font-weight": "bold",
    ...
    arrangeEntries: function () {
        ...
        this.set = p;
        for (var s = this.entries, q = 0; q < s.length; q++) {
            var r = s[q].getBBox(),
                v = r.width;
            v > o && (o = v);
            r = r.height;
        ...
        p.push(c);
        p.translate(b + "," + d);
        if ("top" == a || "bottom" == a) p.pop(), "center" == this.align && p.translate((f - r.width) / 2 + ",0"), "right" == this.align && p.translate(f - r.width + ",0");
        a = j + d + e + 1;
        0 > a && (a = 0);
        g.style.height = a + "px"
    },
    ...
    b, c) {
        ...
        case "triangleDown":
            ...
            break;
        case "bubble":
            c.fill = NaN, c.gradient = "r" + b + "-" + AmCharts.adjustLuminosity(b, - 0.4), f = e.circle(d / 2, d / 2, d / 2).attr(c)
        }
        return f
    },
    validateNow: function () {
    ...
    updateValues: function () {
        for (var a = this.valueLabels, b = this.chart, c = 0; c < a.length; c++) {
            ...
            } else f = b.formatString(this.valueText, e), d.attr({
                text: f
            })
        }
    },
    ...
    draw: function () {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                m + p > h && (m = h - p);
                if (0 < q) {
                    if (o = AmCharts.rect(d, p, e, [n], [this.fillAlpha],
...
AmCharts.AmCoordinateChart = AmCharts.Class({
    ...
    parseSerialData: function () {
        ...
        for (b = 0; b < a.length; b++) k = a[b], k.dataProvider && this.parseGraphData(k)
    },
    processValues: function (a, b, c) {
        var d = {}, e = Number(a[b.valueField + c]);
        isNaN(e) || (d.value = e);
    ...
    removeGraph: function (a) {
        for (var b = this.graphs, c = b.length - 1; 0 <= c; c--) b[c] == a && (b.splice(c, 1), a.destroy());
        this.validateData()
    },
...
AmCharts.AmRectangularChart = AmCharts.Class({
    ...
    resetMargins: function () {
        ...
        if ("serial" == this.chartType) {
            ...
            if ((c = this.categoryAxis) && !c.ignoreAxisWidth) c.setOrientation(!this.rotate), c.fixAxisPosition(), c.fixAxisPosition(), a[c.position] = !0
        } else {
            d = this.xAxes;
            b = this.yAxes;
            ...
            for (c = 0; c < b.length; c++) d = b[c], d.ignoreAxisWidth || (d.setOrientation(!1), d.fixAxisPosition(), a[d.position] = !0)
        }
    ...
    measureMargins: function () {
        var a = this.valueAxes,
            ...
            j = e - c;
        b = f - c;
        for (var l = 0; l < a.length; l++) b = this.getAxisBounds(a[l], g, j, h, b), g = b.l, j = b.r, h = b.t, b = b.b;
    ...
    drawZoomOutButton: function () {
        ...
        e = AmCharts.rect(a.container, c.width + 40, c.height + 15, [e.backgroundColor], [e.backgroundAlpha]);
        b.push(e);
        d.toFront();
        e.hide();
        a.zoomOutButtonBG = e;
    ...
    drawPlotArea: function () {
        ...
        0, 0, "L", a, b, "L", e + a, b, "L", e, 0, "L", 0, 0, "Z"]).attr(h), e.translate(c + "," + (d + f)), this.set.push(e), a = this.container.path(["M", 0, 0, "L", 0, f, "L", a, f + b, "L", a, b, "L", 0, 0, "Z"]).attr(h), a.translate(c + "," + d), this.set.push(a))
    },
    ...
    updateChartCursor: function () {
        ...
        a && (a.x = this.marginLeftReal, a.y = this.marginTopReal, a.width = this.plotAreaWidth,
        a.height = this.plotAreaHeight, a.chart = this)
    },
    ...
    removeTrendLine: function (a) {
        for (var b = this.trendLines, c = b.length - 1; 0 <= c; c--) b[c] == a && b.splice(c, 1)
    },
...
AmCharts.TrendLine = AmCharts.Class({
    ...
    draw: function () {
        ...
        var d, e, f, g, h = a.categoryAxis,
            ...
            q = a.initialValue,
            r = a.finalValue;
        h && (j && (d = h.dateToCoordinate(j)), l && (d = h.categoryToCoordinate(l)),
        k && (e = h.dateToCoordinate(k)), n && (e = h.categoryToCoordinate(n)));
        ...
        !isNaN(d) && !isNaN(e) && !isNaN(f) && !isNaN(f) && (b.rotate ? (b = AmCharts.line(c, [f, g], [d, e], a.lineColor, a.lineAlpha, a.lineThickness, a.dashLength), b.translate(0, a.y)) : (b = AmCharts.line(c, [d, e], [f, g], a.lineColor, a.lineAlpha, a.lineThickness, a.dashLength),
        b.translate(a.x, 0)), a.line = b, a.set.push(b), hoverLine = AmCharts.line(c, [d, e], [f, g], a.lineColor, 0.01, 5), a.set.push(hoverLine), hoverLine.mouseup(function () {
            a.handleLineClick()
        }).mouseover(function () {
            a.handleLineOver()
        }).mouseout(function () {
...
AmCharts.AmSerialChart = AmCharts.Class({
    ...
    drawChart: function () {
        ...
        if (a) if (0 < a.length) {
            ...
            if (c.parseDates && !c.equalSpacing) {
                if (c = this.startTime, d = this.endTime, isNaN(c) || isNaN(d)) c = a[0].time, d = a[b].time
            } else if (c = this.start, d = this.end, isNaN(c) || isNaN(d)) c = 0, d = b;
    ...
    zoom: function (a, b) {
        ...
        c.parseDates && !c.equalSpacing ? this.timeZoom(a, b) : this.indexZoom(a,
        b);
        this.updateDepths()
    },
    ...
    indexZoom: function (a, b) {
        ...
        isNaN(c) || (b != this.end && b - a > c && (a = b - c, this.updateScrollbar = !0), a != this.start && b - a > c && (b = a + c,
        this.updateScrollbar = !0));
    ...
    updateDepths: function () {
        ...
        for (var b = this.graphs, c = 0; c < b.length; c++) {
            ...
            if (e = d.objectsToAddListeners) for (f = 0; f < e.length; f++) d.addClickListeners(e[f]), d.addHoverListeners(e[f])
        }
    ...
    countColumns: function () {
        for (var a = 0, b = this.valueAxes.length, c = this.graphs.length, d, e, f = !1, g, h = 0; h < b; h++) {
            ...
            if ("none" == j || "3d" == j) for (g = 0; g < c; g++) d = this.graphs[g], !d.hidden && d.valueAxis == e && "column" == d.type && (d.columnIndex = a, a++);
            if ("3d" == j) {
    ...
    formatString: function (a, b) {
        ...
        d = b.graph.valueAxis;
        if ((e = d.duration) && !isNaN(b.values.value)) d = AmCharts.formatDuration(b.values.value, e, "", d.durationUnits, d.maxInterval, c), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), d);
...
AmCharts.AmRadarChart = AmCharts.Class({
    ...
    formatString: function (a, b) {
        ...
        c = c.numberFormatter;
        c || (c = this.numberFormatter);
        a = AmCharts.formatValue(a, b.values, ["value"], c, "", this.usePrefixes,
...
AmCharts.AxisBase = AmCharts.Class({
    ...
    positionTitle: function () {
        ...
        if (a) {
            ...
            case "left":
                ...
                break;
            case "right":
                b = l - o.width / 2 - (h + l - (e + g)) + 10 + p, c = j + k / 2, m = 270, n = "start"
            }
            a.attr({
                "text-anchor": n
            });
    ...
    removeGuide: function (a) {
        for (var b = this.guides, c = 0; c < b.length; c++) b[c] == a && b.splice(c,
        1)
    },
...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function () {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
            ...
            if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs && Infinity != this.min && -Infinity != this.max) {
                ...
                r = !1;
                for (d = m; d < p; d += o) t = AmCharts.roundTo(this.step * d + this.min, c), - 1 != ("" + t).indexOf("e") && (r = !0, ("" + t).split("e"));
                ...
                for (d = m; d < p; d += o) if (m = this.step * d + this.min, m = AmCharts.roundTo(m, this.maxDecCount + 1), !(this.integersOnly && Math.round(m) != m)) {
                    ...
                    if (m == this.baseValue && "radar" != j) {
                        var D, T, m = this.visibleAxisWidth,
                            t = this.visibleAxisHeight,
                            v = this.visibleAxisX,
                            y = this.visibleAxisY;
                        "horizontal" == this.orientation ? c >= v && c <= v + m + 1 && (D = [c, c, c + e], T = [0 + t, 0, f]) : c >= y && c <= y + t + 1 && (D = [0, m, m + e], T = [c, c, c + f]);
                        D && (this.grid0 = AmCharts.line(a.container, D, T, this.gridColor,
                        2 * this.gridAlpha, 1, this.dashLength), b.push(this.grid0))
                    }
                }
                e = this.baseValue;
    ...
    stackGraphs: function (a) {
        ...
        var c = [],
            ...
            j, l, k;
        if (("line" == a || "step" == a || "smoothedLine" == a) && ("regular" == b || "100%" == b)) for (k = 0; k < h.length; k++) g = h[k], g.hidden || (l = g.type, g.chart == this.chart && g.valueAxis == this && a == l && g.stackable && (j && (g.stackGraph = j), j = g));
        ...
        for (var a = this.chart.graphs, b = 0; b < a.length; b++) {
            ...
            if (c.valueAxis == this) {
                ...
                var e, f, g = this.end + 2,
                    ...
                    h = this.start;
                0 < h && h--;
                for (var j = this.start; j <= g && !(f = this.data[j].axes[this.id].graphs[c.id],
                e = f.values[d], !isNaN(e)); j++);
                for (d = h; d <= g; d++) {
    ...
    getMinMax: function () {
        ...
        this.logarithmic && (2 < c ? (this.minReal = this.min = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)), this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E))) : (b = Math.pow(10, Math.floor(Math.log(Math.abs(this.min)) * Math.LOG10E)) / 10, a = Math.pow(10,
        Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10, b < a && (this.minReal = this.min = 10 * a)))
    },
    ...
    draw: function () {
        ...
        if (0 < b.length) {
            ...
            if (a.parseDates && !a.equalSpacing) {
                if (a.timeDifference = a.endTime - a.startTime, c = a.choosePeriod(0), d = c.period, b = c.count, o = AmCharts.getPeriodDuration(d, b), o < l && (d = n.period, b = n.count, o = l), n = d, "WW" == n && (n = "DD"), a.stepWidth = a.getStepWidth(a.timeDifference),
                g = Math.ceil(a.timeDifference / o) + 1, k = AmCharts.resetDateToMin(new Date(a.startTime - o), d, b, r).getTime(), n == d && 1 == b && (m = o * a.stepWidth), a.cellWidth = l * a.stepWidth, f = Math.round(k / o), c = -1, f / 2 == Math.round(f / 2) && (c = -2, k -= o), 0 < a.gridCount) for (f = c; f <= g; f++) {
                    p = k + 1.5 * o;
                ...
                if (a.parseDates && a.equalSpacing) {
                    ...
                    g = Math.ceil(a.timeDifference / o) + 1;
                ...
                for (m = 0; f <= a.end + 2; f += g) {
                    ...
                    r = 0;
                    "start" == a.gridPosition && (l -= a.cellWidth / 2, r = a.cellWidth / 2);
            ...
            for (f = 0; f < a.data.length; f++) if (h = a.data[f]) a.parseDates && !a.equalSpacing ? (j = (h.time - a.startTime) * a.stepWidth + a.cellWidth / 2, j = q ? j + a.y : j + a.x) : j = a.getCoordinate(f - e), h.x[a.id] = j
        }
        h = a.guides.length;
        for (f = 0; f < h; f++) j = a.guides[f], d = g = c = NaN, j.toCategory && (d = a.chart.getCategoryIndexByValue(j.toCategory), isNaN(d) || (c = a.getCoordinate(d - e), l = new a.axisItemRenderer(this, c, "", !0, NaN, NaN, j), a.pushAxisItem(l))), j.category && (d = a.chart.getCategoryIndexByValue(j.category), isNaN(d) || (g = a.getCoordinate(d - e), d = (c - g) / 2, l = new a.axisItemRenderer(this, g, j.label, !0, NaN, d, j), a.pushAxisItem(l))), j.toDate && (a.equalSpacing ? (d = a.chart.getClosestIndex(a.data, "time", j.toDate.getTime(), !1, 0, a.data.length - 1), isNaN(d) || (c = a.getCoordinate(d - e))) : (c = (j.toDate.getTime() - a.startTime) * a.stepWidth, c = q ? c + a.y : c + a.x), l = new a.axisItemRenderer(this, c, "", !0, NaN, NaN,
        j), a.pushAxisItem(l)), j.date && (a.equalSpacing ? (d = a.chart.getClosestIndex(a.data, "time", j.date.getTime(), !1, 0, a.data.length - 1), isNaN(d) || (g = a.getCoordinate(d - e))) : (g = (j.date.getTime() - a.startTime) * a.stepWidth, g = q ? g + a.y : g + a.x), d = (c - g) / 2, l = "horizontal" == a.orientation ? new a.axisItemRenderer(this, g, j.label, !1, 2 * d, NaN, j) : new a.axisItemRenderer(this, g, j.label, !1, NaN, d, j), a.pushAxisItem(l)), c = new a.guideFillRenderer(this, c - g, g, j), g = c.graphics(), a.pushAxisItem(c), j.graphics = g, g.index = f, j.balloonText && (g.mouseover(function () {
...
AmCharts.RectangularAxisRenderer = AmCharts.Class({
    construct: function (a) {
        var b = a.axisThickness,
            ...
            o = n.set();
        this.set = o;
        "horizontal" == a.orientation ? (c = AmCharts.line(n, [0, k], [0, 0], c, d, b), this.axisWidth = a.width, "bottom" == a.position ? (a = b / 2 + e + l + j - 1, b = h) : (a = -b / 2 - e + j + g, b = f + h)) : (this.axisWidth = a.height, "right" == a.position ? (c = AmCharts.line(n, [0, 0, - f], [0, l, l - g], c,
        d, b), a = j + g, b = b / 2 + e + f + k + h - 1) : (c = AmCharts.line(n, [0, 0], [0, l], c, d, b), a = j, b = -b / 2 - e + h));
        o.push(c);
...
AmCharts.RectangularAxisItemRenderer = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g, h, j) {
        ...
        if ("horizontal" == Ia) {
            if (b >= N && b <= U + 1 + N && (V = AmCharts.line(o, [b + j, b + j], [0, r], s, q, y), b + j > U + N + 1 ? (V.remove(), V = null) : m.push(V), O = AmCharts.line(o, [b, b + K, b + K], [Y, Y + L, L], B, v, y, J), m.push(O)), u = 0, z = b, g && 90 == D && (z -= k / 2 + 3), !1 == d ? (O = "start", $ || (u = "bottom" == ca ? C ? u + r : u - r : C ? u - r : u + r, z += 3, e && (z += e / 2, O = "middle"))) : O = "middle", 1 == T && 0 < I && !g && (ia = b - ha, fill = AmCharts.rect(o, ia, a.height, [t], [I]), fill.translate(b - ia + K + "," + L), fill.attr({
                "clip-rect": Aa
            }), m.push(fill)), "bottom" == ca ? (u += Y + k / 2 + da, C ? 0 < D ? (u = Y - fa / 2 * Math.sin(Z) - r - 3, z += fa / 2 * Math.cos(Z)) : u -= r + k + 3 + 3 : 0 < D ? (u = Y + fa / 2 * Math.sin(Z) + r + 3, z -= fa / 2 * Math.cos(Z)) : u += r + p + 3 + 3) : (u += L + k / 2 - da, z += K, C ? 0 < D ? (u = fa / 2 * Math.sin(Z) + r + 3, z -= fa / 2 * Math.cos(Z)) : u += r + 3 : 0 < D ? (u = -(fa / 2) * Math.sin(Z) - r - 3, z += fa / 2 * Math.cos(Z)) : u -= r + k + 3 + p + 3), "bottom" == ca ? ia = (C ? Y - r - 1 : Y + p - 1) + da : (ea = K, ia = (C ? L : L - r - p + 1) - da), f && (z += f), L = z, 0 < D && (L += fa / 2 * Math.cos(Z)), P && (L > N + U + 1 || L < N)) m.exclude(P), P.remove(), P = null
        } else {
            b >= pa && b <= Y + 1 + pa && (V = AmCharts.line(o, [0, r], [b + j, b + j], s, q, y), b + j > Y + pa + 1 ? (V.remove(), V = null) : m.push(V), O = AmCharts.line(o, [0, K, U + K], [b, b + L, b + L], B, v, y, J), m.push(O));
            O = "end";
            if (!0 == C && "left" == ca || !1 == C && "right" == ca) O = "start";
            u = b - k / 2;
            1 == T && 0 < I && !g && (N = b - ha, fill = AmCharts.rect(o, a.width, N, [t], [I]), fill.translate(K + "," + (b - N + L)), fill.attr({
                "clip-rect": Aa
            }), m.push(fill));
            u += k / 2;
            ...
            U = pa - 3;
            "right" == ca && (U += L);
            if (P && (u > Y + pa + 1 || u < U)) m.exclude(P), P.remove(), P = null
        }
        V && V.translate(ea + "," + ia);
        !1 == a.visible && (V && (m.exclude(V), V.remove()), P && (m.exclude(P), P.remove(), P = null));
        P && (P.attr({
            "text-anchor": O
        }), P.transform("r" + -D), P.transform("...T" + z + "," + u), a.allLabels.push(P));
        a.counter = 0 == T ? 1 : 0;
        a.previousCoord = b
    },
    graphics: function () {
...
AmCharts.RectangularAxisGuideFillRenderer = AmCharts.Class({
    construct: function (a, b, c, d) {
        ...
        "vertical" == e ? (a = AmCharts.rect(h, a.width, b, k, g), a.translate(j + "," + (c - f + l))) : (a = AmCharts.rect(h,
        b, a.height, k, g), a.translate(c - f + j + "," + l));
        a.attr({
            "clip-rect": d
        });
        this.set.push(a)
...
AmCharts.RadarAxisItemRenderer = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g) {
        ...
        var n = a.axisColor,
            ...
            I, e = a.x,
            f = a.y;
        g ? (B = !0, isNaN(g.tickLength) || (m = g.tickLength), void 0 != g.lineColor && (q = g.lineColor), isNaN(g.lineAlpha) || (p = g.lineAlpha), isNaN(g.dashLength) || (r = g.dashLength), isNaN(g.lineThickness) || (s = g.lineThickness), !0 == g.inside && (J = !0)) : c || (p /= 3, m /= 2);
        var H = "end",
            D = -1;
        J && (H = "start", D = 1);
        if (B) {
            ...
            this.set.push(T);
            I = AmCharts.line(k, [e, e + m * D], [b, b], n, o, s);
            this.set.push(I)
        }
        b = a.y - b;
        if ("polygons" == t) {
            for (var C = [], K = [], L = a.data.length, c = 0; c < L; c++) h = 180 - 360 / L * c,
            C.push(b * Math.sin(h / 180 * Math.PI)), K.push(b * Math.cos(h / 180 * Math.PI));
            C.push(C[0]);
            K.push(K[0]);
        ...
        if (1 == d && 0 < y && !g) {
            g = a.previousCoord;
            if ("polygons" == t) {
                for (c = L; 0 <= c; c--) h = 180 - 360 / L * c, C.push(g * Math.sin(h / 180 * Math.PI)), K.push(g * Math.cos(h / 180 * Math.PI));
                C = AmCharts.polygon(k, C, K, [v], [y])
...
AmCharts.RadarAxisGuideFillRenderer = AmCharts.Class({
    construct: function (a, b, c, d) {
        ...
        if ("polygons" == a.gridType) {
            for (var b = [], d = [], l = a.data.length, k = 0; k < l; k++) j = 180 - 360 / l * k, b.push(c * Math.sin(j / 180 * Math.PI)), d.push(c * Math.cos(j / 180 * Math.PI));
            b.push(b[0]);
            d.push(d[0]);
            for (k = l; 0 <= k; k--) j = 180 - 360 / l * k, b.push(h * Math.sin(j / 180 * Math.PI)), d.push(h * Math.cos(j / 180 * Math.PI));
            this.fill = AmCharts.polygon(e, b, d, [g], [f])
        } else h = c - Math.abs(b), this.fill = AmCharts.wedge(e, 0, 0, j, d - j, c, c, h, 0, {
            fill: g,
            "fill-opacity": f,
            stroke: 0,
            "stroke-opacity": 0,
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    draw: function () {
        ...
        if (this.data && 0 < this.data.length) {
            var a = !1;
            "xy" == this.chartType ? this.xAxis.axisCreated && this.yAxis.axisCreated && (a = !0) : this.valueAxis.axisCreated && (this.columnsArray = [], a = !0);
    ...
    createRadarGraph: function () {
        for (var a = this.valueAxis.stackType, b = [], c = [], d, e, f = this.start; f <= this.end; f++) {
    ...
    createSerialGraph: function () {
        var a = this,
            ...
            o = a.rotate,
            m = a.columnCount,
            p = AmCharts.toCoordinate(a.cornerRadiusTop,
            h / 2),
            s = a.connect,
            q = [],
            r = [],
            v, y, B = a.chart.graphs.length,
            J, t = a.dx / a.depthCount,
            I = a.dy / a.depthCount,
            H = f.stackType,
            D = a.labelPosition,
            T = a.start,
        ...
        for (M = T; M <= C; M++) {
            ...
            var ra, Ca = NaN,
                ...
                Xa = za,
                X = pa;
            void 0 != u.color && (ua = [u.color]);
            u.fillColors && (ua = u.fillColors);
            isNaN(u.alpha) || (Xa = [u.alpha]);
            var ma = u.values;
            ...
            if (ma) {
                ...
                switch (g) {
                case "line":
                    isNaN(S) ? s || (a.drawLineGraph(q, r, ka, la), q = [], r = [], ka = [], la = []) : (S < ca && (u.isNegative = !0), q.push(x), r.push(w), aa = x, ba = w, sa = x, ta = w, Va && (ka.push(Q), la.push(R)));
                    break;
                case "smoothedLine":
                    isNaN(S) ? s || (a.drawSmoothedGraph(q, r, ka, la), q = [], r = [], ka = [], la = []) : (S < ca && (u.isNegative = !0), q.push(x), r.push(w), aa = x, ba = w, sa = x, ta = w, Va && (ka.push(Q), la.push(R)));
                    break;
                case "step":
                    isNaN(S) ? s || (a.drawLineGraph(q, r, ka, la), q = [], r = [], ka = [], la = []) : (S < ca && (u.isNegative = !0), o ? (v && s && (q.push(v), r.push(w - Ma)), r.push(w - Ma), q.push(x), r.push(w + $a), q.push(x)) : (y && s && (r.push(y), q.push(x - Ma)), q.push(x - Ma), r.push(w), q.push(x + $a), r.push(w)), v = x, y = w, aa = x, ba = w, sa = x, ta = w);
                    break;
                case "column":
                    if (!isNaN(S)) {
                        ...
                        if (A) {
                            if (!K) {
                                ...
                                if ("regular" == H || "100%" == H) D = "middle", J = o ? 0 < ma.value ? (a.end + 1 - M) * B + c : (a.end + 1 - M) * B - c : 0 < ma.value ? B * M + c : B * M - c;
                                a.columnsArray.push({
                                    column: A,
                                    depth: J
                                });
                                ...
                                if (0 == a.dx && 0 == a.dy && 0 < a.sDur && !a.animationPlayed) {
                                    ...
                                    a.seqAn ? (A.set.hide(), a.animationArray.push({
                                        ...
                                        a.animate.call(a)
                                    }, 1E3 * a.sDur / (a.end - a.start + 1) * (M - a.start)), a.timeOuts.push(da)) : a.animate(A.set, ra, wa, va)
                                }
                                for (var xa = A.set, na = 0; na < xa.length; na++) xa[na].dItem = u, xa[na].attr({
                                    cursor: Wa
                                });
                    ...
                    if (!isNaN(ga) && !isNaN(Za) && !isNaN(Ya) && !isNaN(S)) {
                        ...
                        if (o) {
                            if (E = w - h / 2, G = Q, F = h, E + F > n + l && (F = n + l - E), E < n && (F -= n - E, E = n), E < n + l && 0 < F) {
                                var bb, cb;
                                S > ga ? (bb = [x, Qa], cb = [Q, Pa]) : (bb = [Q, Qa], cb = [x, Pa]);
                                w < n + l && w > n && (Ra = AmCharts.line(e, bb, [w, w], X, N, $), ab = AmCharts.line(e, cb, [w, w], X, N, $));
                                1 > Math.abs(x - Q) ? (A = new AmCharts.line(e, [0, 0], [0, F], X, N, 1), A.attr({
                                    x: G,
                                    y: E
                            ...
                            1 > Math.abs(w - R) ? (A = new AmCharts.line(e, [0, F], [0, 0], X, N, 1), A.translate(G + "," + E)) : (A = new AmCharts.Cuboid(e, F, w - R, t, I, ua, Xa, $, X, N, V, p), A.x(G), A.y(E));
                            var db, eb;
                            S > ga ? (db = [w, Ea], eb = [R, Da]) : (db = [R, Ea], eb = [w, Da]);
                            x < k + j && x > k && (Ra = AmCharts.line(e, [x, x], db, X, N, $), ab = AmCharts.line(e, [x, x], eb, X, N, $))
                        }
                        if (A && (A.set ? U.push(A.set) : U.push(A), Ra && (U.push(Ra), U.push(ab)),
                        aa = x, ba = w, sa = x, ta = w, !K)) {
                            ...
                            if (A.set) {
                                xa = A.set;
                                for (na = 0; na < xa.length; na++) xa[na].dItem = u, xa[na].attr({
                                    cursor: Wa
                                });
                                a.objectsToAddListeners.push(A.set)
                            }
                ...
                case "ohlc":
                    if (!isNaN(ga) && !isNaN(Za) && !isNaN(Ya) && !isNaN(S)) {
                        ...
                        var fb, gb, hb;
                        o ? (gb = AmCharts.line(e, [Q, Q], [w - h / 2, w], X, N, $, Y), fb = AmCharts.line(e, [Pa, Qa], [w, w], X, N, $, Y), hb = AmCharts.line(e, [x, x], [w, w + h / 2], X, N, $, Y)) : (gb = AmCharts.line(e, [x - h / 2, x], [R, R], X, N, $, Y), fb = AmCharts.line(e, [x, x], [Da, Ea], X, N, $, Y), hb = AmCharts.line(e, [x, x + h / 2], [w, w], X, N, $, Y));
                        U.push(gb);
                        U.push(fb);
                        U.push(hb);
                        aa = x;
                    ...
                    if (a.end - a.start <= pb || 0 == pb) {
                        ...
                        if (a.labelText) {
                            ...
                            case "bottom":
                                ...
                                break;
                            case "middle":
                                "column" == g && (o ? (Ga = -(x - Q) / 2 - t, Math.abs(x - Q) < Ha && !a.showAllValueLabels && (W.remove(), a.set.exclude(W), W = null)) : (Sa = -(w - R) / 2 + 1 - I, Math.abs(w - R) < ib && !a.showAllValueLabels && (W.remove(), a.set.exclude(W), W = null)))
                            }
                            if (W) if (W.attr({
                                x: aa + Ga,
                                y: ba + Sa
                            }), oa = W.getBBox(), o) {
                                if (oa.y < n || oa.y + oa.height > n + l) W.remove(), a.set.exclude(W), W = null
                            } else if (oa.x < k || oa.x + oa.width > k + j) W.remove(), a.set.exclude(W), W = null
                        }
                    }
                }
            }
        }
        if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? a.drawSmoothedGraph(q, r, ka, la) : a.drawLineGraph(q, r, ka, la), K || a.launchAnimation()
    },
    ...
    drawLineGraph: function (a, b, c, d) {
        if (1 < a.length) {
            ...
            if (void 0 != this.fillAlphas && 0 != this.fillAlphas) {
                ...
                if (this.negativeFillColors || void 0 != this.negativeLineColor) a = this.fillAlphas, this.negativeFillAlphas && (a = this.negativeFillAlphas), b = this.negativeLineColor, this.negativeFillColors && (b = this.negativeFillColors), e = AmCharts.polygon(this.container, e, f, b, a), this.set.push(e), this.negativeObjectsToClip.push(e)
            }
        }
    },
    drawSmoothedGraph: function (a, b) {
        if (1 < a.length) {
            ...
            if (0 < this.fillAlphas) {
                ...
                c.push("L", a[0], b[0]);
                var d = new AmCharts.Bezier(this.container, a, b, NaN, NaN, 0, this.fillColors, this.fillAlphas,
                this.dashLength, c);
    ...
    createBullet: function (a, b, c) {
        ...
        if ("none" != this.bullet || a.bullet) {
            ...
            case "triangleRight":
                ...
                break;
            case "bubble":
                h = AmCharts.circle(this.container,
                f / 2, j, n, g, l, k, !0)
            }
        }
        if (this.customBullet || a.customBullet) e = this.customBullet, a.customBullet && (e = a.customBullet), e && (h && h.remove(), "function" == typeof e ? (h = new e, h.chart = this.chart, a.bulletConfig && (h.availableSpace = c, h.graph = this, a.bulletConfig.minCoord = this.minCoord - c, h.bulletConfig = a.bulletConfig), h.write(this.container), h = h.set) : (this.chart.path && (e = this.chart.path + e), h = this.container.image(e, 0, 0, f, f).attr({
        ...
        if (h) {
            ...
            if ("serial" == this.chartType && (b < this.x || b > this.x + this.width || c < this.y - f / 2 || c > this.y + this.height)) h.remove(), h = null;
    ...
    handleDoubleClick: function (a) {
        ...
        a), this.chart.fire("doubleClickGraphItem", a))
    },
    zoom: function (a, b) {
        this.start = a;
        this.end = b;
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    updateData: function () {
        ...
        if ((this.data = a) && 0 < a.length && a) this.firstTime = a[0].time, this.lastTime = a[a.length - 1].time
    },
    createCursor: function () {
        var a = this.chart,
            ...
            s = c.tickLength;
        g.pointerWidth = s;
        a ? (h = [0, m, m + n], j = [0, 0, o]) : (h = [n, 0, 0], j = [o, 0, p]);
        this.line = b = AmCharts.line(this.container, h, j, this.cursorColor, b, 1);
        b.translate(l + "," + k);
        this.set.push(b);
        a ? (e && (g.pointerWidth = 0), "right" == d ? e ? g.setBounds(l, k + o, l + m + n, k + p + o) : g.setBounds(l + m + n + f, k + o, l + m + 1E3, k + p + o) : e ? g.setBounds(l, k, m + l, p + k) : g.setBounds(-1E3, - 1E3, l - s - f, k + p + 15)) : (g.maxWidth = m, c.parseDates && (s = 0, g.pointerWidth = 0), "top" == d ? e ? g.setBounds(l + n, k + o, m + n + l, p + k) : g.setBounds(l + n, - 1E3, m + n + l, k + o - s - f) : e ? g.setBounds(l, k, m + l, p + k - s) : g.setBounds(l, k + p + s + f - 1, l + m, k + p + s + f));
        this.hideCursor()
    },
    ...
    b) {
        ...
        0 < e && 0 < f && (this.selection = AmCharts.rect(this.container, e, f, [this.cursorColor], [this.selectionAlpha]), this.selection.translate(c + "," + d), this.set.push(this.selection))
    },
    ...
    updateCursor: function (a, b) {
        var c = this.chart,
            d = c.mouseX,
            e = c.mouseY;
        this.drawingNow && (AmCharts.removeObject(this.drawingLine),
        ...
        if (this.enabled) {
            ...
            var f = c.categoryAxis,
                ...
                T = f.axisThickness;
            if (c.mouseIsOver || t || I || this.forceShow) if (this.forceShow = !1, I) {
                k = this.panClickPos;
                ...
                v = !0;
                D && t && (v = !1);
                this.categoryBalloonEnabled && v ? (p ? (s && ("right" == J ? r.setBounds(g,
                ...
                if (H && this.valueBalloonsEnabled && v && c.balloon.enabled) {
                    ...
                    if (this.oneBalloonOnly) for (var j = Infinity, C, v = 0; v < H.length; v++) q = H[v], q.showBalloon && !q.hidden && q.balloonText && (r = o.axes[q.valueAxis.id].graphs[q.id], y = r.y, isNaN(y) || (p ? Math.abs(d - y) < j && (j = Math.abs(d - y), C = q) : Math.abs(e - y) < j && (j = Math.abs(e - y), C = q)));
                    for (v = 0; v < H.length; v++) if (q = H[v], !(this.oneBalloonOnly && q != C) && q.showBalloon && !q.hidden && q.balloonText && (r = o.axes[q.valueAxis.id].graphs[q.id], y = r.y, !isNaN(y))) {
                        l = r.x;
                        m = !0;
                        if (p) {
    ...
    handleMouseUp: function () {
        ...
        this.enabled && (this.pan ? this.rolledOver = !1 : this.zoomable && this.zooming && ("cursor" == this.type ? (this.rotate ? this.selectionPosY = b = a : this.selectionPosX = b, 2 > Math.abs(b - this.initialMouse) && this.fromIndex == this.index || (b = {
            type: "zoomed"
        }, this.index < this.fromIndex ? (b.end = this.fromIndex, b.start = this.index) : (b.end = this.index, b.start = this.fromIndex), a = this.chart.categoryAxis, a.parseDates && !a.equalSpacing && (b.start = this.data[b.start].time, b.end = this.data[b.end].time), AmCharts.removeSet(this.allBullets), this.skipZoomDispatch || (b.target = this, this.fire("zoomed", b)))) : 3 > Math.abs(b - this.initialMouseX) && 3 > Math.abs(a - this.initialMouseY) || (a = this.selection.getBBox(), b = {
            type: "zoomed"
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({
    ...
    relativeZoom: function (a, b) {
        ...
        var c = this.position = b,
            d;
        this.rotate ? (c += this.y,
        d = c + this.height / a) : (c += this.x, d = c + this.width / a);
    ...
    handleBackgroundClick: function () {
        if (!this.resizingRight && !this.resizingLeft) {
            ...
            var g = this.y,
                h = this.x,
                j = this.rotate;
            j ? (a = "y", b = b.mouseY - e / 2, b = AmCharts.fitToBounds(b, g, g + this.height - e)) : (a = "x", b = b.mouseX - f / 2, b = AmCharts.fitToBounds(b, h, h + this.width - f));
...
AmCharts.ChartScrollbar = AmCharts.Class({
    ...
    draw: function () {
        ...
        if (l = a.graph) {
            ...
            Infinity != o && (k.minimum = o); - Infinity != m && (k.maximum = m + 0.1 * (m - o));
            ...
            n.fillColors = [a.selectedGraphFillColor];
            n.connect = l.connect;
            n.hidden = l.hidden;
            n.width = h;
            n.height = j;
    ...
    dispatchScrollbarEvent: function () {
        if (this.skipEvent) this.skipEvent = !1;
            ...
            if (e.parseDates && !e.equalSpacing) {
                ...
                e > a && (e = a);
                if (e != this.startTime || a != this.endTime) this.startTime = e, this.endTime = a, b = {
                    type: "zoomed",
                    start: e,
                    end: a,
            ...
            } else if (e.startOnAxis || (b += d / 2), c -= this.stepWidth / 2, d = e.xToIndex(b), b = e.xToIndex(b + c), d != this.start || this.end != b) e.startOnAxis && (this.resizingRight && d == b && b++, this.resizingLeft && d == b && (0 < d ? d-- : b = 1)), this.start = d, this.end = this.dragging ? this.start + this.difference : b, b = {
                type: "zoomed",
                start: this.start,
                end: this.end
            }, e.parseDates && (a[this.start] && (b.startDate = new Date(a[this.start].time)), a[this.end] && (b.endDate = new Date(a[this.end].time))), this.fire(b.type, b)
        }
    },
    zoomScrollbar: function () {
        var a, b;
        ...
        var c = this.categoryAxis,
            d;
        c.parseDates && !c.equalSpacing ? (d = c.stepWidth, b = b[0].time, a = d * (this.startTime - b), b = d * (this.endTime - b + c.minDuration()), this.rotate ? (a += this.y, b += this.y) : (a += this.x, b += this.x)) : (a = b[this.start].x[c.id],
        b = b[this.end].x[c.id], d = c.stepWidth, c.startOnAxis || (c = d / 2, a -= c, b += c));
        this.stepWidth = d;
...
AmCharts.polygon = function (a, b, c, d, e, f, g, h, j) {
    ...
    for (g = 1; g < b.length; g++) f.push("L"), f.push(Math.round(b[g]) + e), f.push(Math.round(c[g]) + e);
    f.push("Z");
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, j, l) {
    ...
    e = a.set();
    if (0 < j) {
        var v = 0 < h ? a.path(["M", n, o + j, "L", m, p + j, "A", f, g, 0, d, 1, s, q + j, "L", b, c + j, "A", h, k, 0, d, 0, n, o + j, "z"]).attr(r) : a.path(["M", n, o + j, "L", m, p + j, "A", f, g, 0, d, 1, s, q + j, "L", b, c + j, "Z"]).attr(r);
        e.push(v);
        v = a.path(["M", n, o, "L", n, o + j, "L", m, p + j, "L", m, p, "L", n, o, "z"]).attr(r);
        j = a.path(["M", s, q, "L", s, q + j, "L", b, c + j, "L", b, c, "L", s, q, "z"]).attr(r);
        e.push(v);
        e.push(j)
    }
    l.gradient && (l.fill = null);
    a = 0 < h ? a.path(["M", n, o, "L", m, p, "A", f, g, 0, d, 1, s, q, "L", b, c, "A", h, k, 0, d, 0, n, o, "Z"]).attr(l) : a.path(["M", n, o, "L", m, p, "A", f, g, 0, d, 1, s, q, "L", b, c, "Z"]).attr(l);
    e.push(a);
    return e
};
...
AmCharts.AmPieChart = AmCharts.Class({
    ...
    drawChart: function () {
        ...
        if (b && 0 < b.length) {
            ...
            a.chartDataLabels = [];
            a.ticks = [];
            var l, k, n, o = AmCharts.toNumber(a.labelRadius),
                m = a.measureMaxLabel();
            if (!a.labelText || !a.labelsEnabled) o = m = 0;
            l = void 0 == a.pieX ? (c - f - g) / 2 + f : e(a.pieX, a.realWidth);
            ...
            e = e(a.innerRadius, n);
            e >= n && (e = n - 1);
            d = AmCharts.fitToBounds(a.startAngle,
            0, 360);
            ...
            for (j = 0; j < b.length; j++) if (c = b[j], !0 != c.hidden && 0 < c.percents) {
                ...
                f = AmCharts.wedge(a.container, s, q, d, p, n, h, e, a.depth3D,
                f);
                b[j].wedge = f;
    ...
    arrangeLabels: function () {
        ...
        b = a.length, c = this.chartDataLabels, d, e = b - 1; 0 <= e; e--) d = a[e], 0 == d.labelQuarter && !d.hidden && c[e] && (d = d.index, this.checkOverlapping(d, 0, !0, 0));
        for (e = 0; e < b; e++) d = a[e], 1 == d.labelQuarter && !d.hidden && c[e] && (d = d.index, this.checkOverlapping(d, 1, !1, 0));
        for (e = b - 1; 0 <= e; e--) d = a[e], 2 == d.labelQuarter && !d.hidden && c[e] && (d = d.index, this.checkOverlapping(d, 2, !0, 0));
        for (e = 0; e < b; e++) d = a[e], 3 == d.labelQuarter && !d.hidden && c[e] && (d = d.index, this.checkOverlapping(d, 3, !1, 0))
    },
    checkOverlapping: function (a, b, c, d) {
        var e, f, g, h = this.chartData,
            j = this.chartDataLabels;
        if (!0 == c) for (f = a + 1; f < h.length; f++) g = h[f], g.labelQuarter == b && !g.hidden && j[f] && !0 == AmCharts.hitTest(j[a].getBBox(), j[f].getBBox()) && (e = !0);
        else for (f = a - 1; 0 <= f; f--) g = h[f], g.labelQuarter == b && !g.hidden && j[f] && !0 == AmCharts.hitTest(j[a].getBBox(), j[f].getBBox()) && (e = !0);
        g = j[a].getBBox();
    ...
    startSlices: function () {
        for (var a = this, b = 500 * (a.startDuration / a.chartData.length),
        c = 0; c < a.chartData.length; c++) if (0 < a.startDuration && a.sequencedAnimation) {
    ...
    pullInAll: function (a) {
        for (var b = this.chartData, c = 0; c < this.chartData.length; c++) c != a && b[c].pulled && this.pullSlice(b[c], 0)
    },
    pullOutAll: function () {
...
AmCharts.AmXYChart = AmCharts.Class({
    ...
    cleanChart: function () {
        AmCharts.callMethod("destroy", [this.valueAxes,
        this.graphs, this.scrollbarVertical, this.scrollbarHorizontal, this.chartCursor])
    },
    zoomChart: function () {
    ...
    updateTrendLinesDepth: function () {
        ...
        for (i = 0; i < a.length; i++) {
            var b = a[i],
                c = b.set;
            c && c.insertBefore(this.mostFrontObj);
            if (c = b.line) b = b.valueAxis, c.attr({
    ...
    updateDepths: function () {
        ...
        for (var b = this.graphs, c = 0; c < b.length; c++) {
            ...
            if (f) for (e = 0; e < f.length; e++) d.addClickListeners(f[e]), d.addHoverListeners(f[e])
        }
        this.updateTrendLinesDepth();
    ...
    formatString: function (a, b) {
        ...
        c || (c = this.numberFormatter);
        a = AmCharts.formatValue(a, b.values, ["value", "x", "y"],
        c);
        return a = AmCharts.AmSerialChart.base.formatString.call(this, a, b)
    },
    addChartScrollbar: function (a) {
    ...
    updateMargins: function () {
        ...
        if (a = this.scrollbarHorizontal) this.getScrollbarPosition(a, !1, this.xAxes[0].position), this.adjustMargins(a, !1)
    },
    updateScrollbars: function () {
    ...
    handleAxisSelfZoom: function (a) {
        if ("horizontal" == a.valueAxis.orientation) {
            ...
            this.horizontalPosition = a;
            this.widthMultiplyer = b
        } else b = this.fitMultiplyer(a.multiplyer), a = -a.position / this.heightMultiplyer * b, c = -(this.plotAreaHeight * b - this.plotAreaHeight), a < c && (a = c), this.verticalPosition = a, this.heightMultiplyer = b;
        this.zoomChart();
        this.zoomScrollbars()
    },
    removeChartScrollbar: function () {
        AmCharts.callMethod("destroy", [this.scrollbarHorizontal,
        this.scrollbarVertical]);
