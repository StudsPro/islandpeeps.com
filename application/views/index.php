...
<link href="http://fonts.googleapis.com/css?family=Aeolus" rel="stylesheet" type="text/css"/>
<link href="http://fonts.googleapis.com/css?family=BlackJack" rel="stylesheet" type="text/css"/>
<link href="http://fonts.googleapis.com/css?family=koala" rel="stylesheet" type="text/css"/>
<link href="http://fonts.googleapis.com/css?family=Learning Curve Dashed" rel="stylesheet" type="text/css"/>

<style>
.skiptranslate{display:none;}
.funfacts {color: #78E62A;font-size: 2em !important;font-weight: normal !important; display: block; }/*color:rgb(223,69,47)*/
...
/*#showlang{position: absolute;right: 10px;width: 14%;z-index: 99999;}*/
#showlang{position: absolute;width: 100%;z-index: 1;text-align: right;background: rgba(0,0,0,.5);right: 0;}
/*.translation-links > li {    float: left;    width: 50%; display:block ;}*/
.translation-links > li { display:inline-block ;vertical-align: middle;}
.translation-links > li a:hover{color: #069b3f;}
/*.translation-links {display: inline-block; width: 80%; }*/
.translation-links {display: inline-block; width: 25%;padding-right: 1%; }
</style>
...
<!-- Facebook script End--> 
<img src="<?php echo base_url() ?>library/Island_Peeps_files/custom_logo.png" alt="Island Pees" style="position:absolute; z-index:99999; padding:13px; top:10px; left:40px;width:248px;" class="logo_bg lazy">


<div  id="showlang" class="">
<ul class="translation-links" >
  <li class="language-spanish"><a href="#" class="spanish" data-lang="Spanish">Espa&ntilde;ol</a></li><!-- Spanish  -->
  <li class="language-english notdisLang"><a href="#" class="english" data-lang="English">English</a></li><!-- English -->
</ul>
</div>
...
<div class="screen" id="screen-1" data-url="home" data-video="<?php echo base_url()."library/upload/".$path_partsIntro['filename'];?>">
...
<div class="screen map" id="screen-2" data-url="map" style="background-color:#40a4df; margin-top:0px;">
<div> <a  class="gotopage scroll-link my-button btt red">Click island to go to page &#9654;</a>
...
<?php 
$arrAbout = front_about();
$banners6=front_banner(9);
$path_partsIntro2 = @pathinfo("library/upload/".$banners6->background);
$sliderImgScreen2 = @pathinfo("library/upload/".$banners6->background_img);?>
<div class="screen" id="screen-3" data-url="suggestion" data-video="<?php echo base_url()."library/upload/".$path_partsIntro2['filename'];?>"> 
...
<?php 
 $linkUsFormText=$banners6->description;
...
<input type="image" src="<?php echo base_url();?>images/send.png" alt="" class="send_sm_bt"/> 
</p>
</div>
...
$sliderImgScreen3 = @pathinfo("library/upload/".$banners1->background_img);?>

<div class="screen" id="screen-4" data-url="haiti-banner" data-video="<?php echo base_url()."library/upload/".$path_partsIntro3['filename'];?>"> 
...
$sliderImgScreen4 = @pathinfo("library/upload/".$banners2->background_img);?>
<div class="screen" id="screen-5" data-url="jamaica-banner" data-video="<?php echo base_url()."library/upload/".$path_partsIntro4['filename'];?>"> 
...
$sliderImgScreen5 = @pathinfo("library/upload/".$banners4->background_img);?>

<div class="screen" id="screen-6"  data-url="puertorico-banner" data-video="<?php echo base_url()."library/upload/".$path_partsIntro5['filename'];?>"> 
...
$sliderImgScreen6 = @pathinfo("library/upload/".$banners5->background_img);?>
<div class="screen" id="screen-7" data-url="trinidad-banner" data-video="<?php echo base_url()."library/upload/".$path_partsIntro6['filename'];?>"> 
...
//print_r($banners8);
//exit;
 $sliderImgScreen8 = pathinfo("library/upload/".$banners8->background_img);?>
<div class="screen" id="screen-8" data-url="stats"> 
...
$path_partsIntro2 = @pathinfo("library/upload/".$banners6->background);
$sliderImgScreen2 = @pathinfo("library/upload/".$banners6->background_img);?>
<div class="screen" id="screen-9" data-url="about" data-video="<?php echo base_url()."library/upload/".$path_partsIntro2['filename'];?>"> 
<img class="big-image lazy" src="<?php echo  base_url()."library/upload/".$sliderImgScreen2['basename'];?>" width="100%" style="margin-right:20px;" border="0" align="left">
<div>
<div class="span_1 col clearfix " style="margin-right:9%;"> </div>
<div class="span_4 col clearfix blcc_txt" style="margin-right:3%; ">
...
//$linkUsFormText='';
//echo "<br>"; 
 //echo "<pre>";print_r($arrAbout);exit;
foreach($arrAbout as $rowAbout){
...
<!--<link href="http://fonts.googleapis.com/css?family=Cartoonist+Hand" rel="stylesheet" type="text/css"> -->
<style>.scrmenu{color: #FFF;  display: block;  z-index: 999;  text-indent: initial;  color: #fff;  font-size: 14px;  bottom: 0;font-family:remachine_scriptregular;  font-weight:bold; }
/*  font-family:remachine_scriptregular;*/
/*.menu .menu-link, .menu .menu-logo {height:132px !important;}*/
.menutext .menu-tab a{padding-top: 110px !important; text-decoration: none !important; }

.menutext .menu-tab .menu-logo {background-position: center center !important;
background-size: auto auto !important;}
.menutext .menu-tab .about {background-position: center center !important;
background-size: auto auto !important;}
.menutext .menu-tab .suggestion {background-position: center center !important;
background-size: auto auto !important;}
.menutext .menu-tab .map {background-position: center center !important;
background-size: auto auto !important;}
.menutext .menu-tab .ats {background-position: center center !important;
background-size: auto auto !important;}
.menutext .menu-tab .cps {background-position: center center !important;
background-size: auto auto !important;}
.menutext .menu-tab .perspectives {background-position: center center !important;
background-size: auto auto !important;}
.menutext .menu-tab .profiles {background-position: center center !important;
background-size: auto auto !important;}
.menutext .menu-tab .diaspora {background-position: center center !important;
background-size: auto auto !important;}  
...
<nav id="screen-menu" class="menu menutext">
<ul role="navigation">
<li class="menu-tab menu-tab1 home selected" data-url="home"> <a role="tab" class="intro menu-logo menutext"><span class=" scrmenu">HOME</span></a> </li>
<li class="menu-tab menu-tab1 map" data-url="map" > <a role="tab" class="map menu-link" ><span class="scrmenu">MAP</span></a> </li>
<li class="menu-tab menu-tab1 suggestion" data-url="suggestion" > <a role="tab" class="suggestion menu-link" href="#getshowsuggestion"><span class=" scrmenu">SUGGESTION</span></a> </li>
<li class="menu-tab menu-tab1 haiti-banner" data-url="haiti-banner" > <a role="tab" class="ats menu-link" href="#haiti"><span class=" scrmenu">HAITI</span></a> </li>
<li class="menu-tab menu-tab1 jamaica-banner" data-url="jamaica-banner"> <a role="tab" class="cps menu-link" href="#jamaica"><span class=" scrmenu">JAMAICA</span></a> </li>
<li class="menu-tab menu-tab1 puertorico-banner" data-url="puertorico-banner"> <a role="tab" class="perspectives menu-link" href="#puertorico"><span class=" scrmenu">PUERTO RICO</span></a> </li>
<li class="menu-tab menu-tab1 trinidadandtobago-banner" data-url="trinidadandtobago-banner" > <a role="tab" class="profiles menu-link" href="#trinidadandtobago"><span class=" scrmenu">TRINIDAD</span></a> </li>
<li class="menu-tab menu-tab1 stats" data-url="stats" > <a role="tab" class="diaspora menu-link" href="#diaspora"><span class=" scrmenu">STATS</span></a> </li>
<li class="menu-tab menu-tab1 about" data-url="about" > <a role="tab" class="about menu-link"><span class=" scrmenu">ABOUT</span></a></li>
</ul>
</nav>
...
<!-- MAIN_CATO END --> 
<style>
#top-menu li.customtop > ul > li {  float: none;}
#top-menu ul li {   float: left; width: 12.2%;letter-spacing: .7px;}
.customtop { position: relative;display: inline-block !important; color: #fff !important; text-align: left !important;  width: 12% !important;  font-size: 18px !important;}
.customtop ul li {width:auto !important;font-size: 11px;text-align: left !important;font-weight: bold;}
.countrys{display:block !important;color: #fff !important;cursor: pointer !important; line-height:20px;}
.countrys:hover{background-color: #666 !important;background-image: none !important; background:url(black_trans.png);}
.countrys:hover:before {	background-color:#E9AD39;	content:"";	height:3px;	left:0;	position:absolute;	top:-3px;	width:100%}
.countryschange{color: #00CCFF !important;cursor: pointer !important; border-top: 3px solid #E9AD39; background-color: #666 !important;background-image: none !important; background:url(black_trans.png);}
.countryschange > a{color: #00CCFF !important;cursor: pointer !important; background-color: #666 !important;background-image: none !important; background:url(black_trans.png);}
.memecontent{display: block !important; }
.memecontent:hover{background-color: #666 !important;background-image: none !important; background:url(black_trans.png);}
.memecontent:hover:before {	background-color:#E9AD39;	content:"";	height:3px;	left:0;	position:absolute;	top:-3px;	width:100%}
.memecontent a{margin-top: 0px;font-family: remachine_scriptregular !important;font-weight: bold !important; display: block !important;color: white !important;text-decoration: none !important;font-size: 11px;line-height:20px;}/*remachine_scriptregular */
.memecontent .memeouter{   color: #fff !important;  background-color: #73DB2C !important;  height: 33px;  line-height: 27px;  border: 2px solid #fff;  width: 112px;  text-align: center;  border-radius: 6px;}
.translation-links > li.notdisLang{display:none;}
</style>
   ...
   foreach($arry as $key)
     {
       $i++; 
        ?>
        <li class="menu-tab customtop">
        <ul>
        <?php
        foreach($key as $val)
         {  
             $siteurl=removeUnsed($val->region_name);
            ?> <li class="countrys" id="countrys_<?php echo $val->id;?>"   onclick="redirectregion('<?php echo $siteurl;?>')"><?php echo $val->region_titlebanner;?></li> <?php
            
         }
        if($count_arry== $i)
        {
          //  echo '<li class=" memecontent " id="getmemeb" ><a role="tab" href="#meme" id="memeb" >ME ME</a></li>
               //   <li class="showsuggestion memecontent suggestionLink" id="getstore"><a  href="#getshowsuggestion" >SUGGESTION</a></li>';
        } 
...
?>
    <li class="menu-tab customtop"> 
  <ul> 
       <?php echo   '<li class="countrys memecontent " id="getmemeb" ><a role="tab" href="#meme" id="memeb" >Me Me</a></li>
                  <li class="showsuggestion memecontent mapLink" id="getmap"><a  href="javascript:void(0)" >Map</a></li>
                  <li class="showsuggestion memecontent statsLink" id="getstats"><a  href="javascript:void(0)" >Stats</a></li>
                  <li class="showsuggestion memecontent suggestionLink" id="getstore"><a  href="javascript:void(0)" >Suggestion</a></li>';
                  ;?>
   </ul>
   </li>
  <!--<li class="menu-tab customtop"> 
  <ul> 
    <li class="memecontent"><a role="tab" href="#memegallery" id="memeb" ><div class="memeouter" id="memeclick"><span class="memeinner"> ME ME </span></div></a></li>
    <li class="memecontent"><a target="_blank" href="#" ><div class="memeouter" id="memeclick"><span class="memeinner"> STORE </span></div></a></li> 
     </ul>
   </li>  -->
</ul> 
</nav>
...
<div class="category clf container ah_lin" id="recentlyadded" style="padding-bottom:5%;" data-category="primary-camp-life">
...
//echo "<pre>";print_r($rowRecentAdded);exit;
...
<?php }else{?>
<div id="showanguilla">
<div id="<?php echo removeUnsed($regionObject->region_name);?>" data-cnt="1" data-id="<?php echo $regionObject->id;?>" class="row header gradient clearfix category reg_part">
<?php 
...
include("memePage.php");?>
</div>
<!-- END MEMEGALLERY DIV HERE-->
<footer class="clearfix"> <img src="<?php echo base_url().'library/'?>Island_Peeps_files/logo_footer.png" width="300" height="118" class="footer-logo lazy" alt=""> <small>&copy;<?php echo date("Y")?> Island Peeps. All rights reserved </small> </footer>
<?php 
...
<script src="<?php echo base_url().'library/';?>js/jquery.waypoints.js"></script> 
...
function ChangeUrl(url) {
    ...
    if (typeof (history.replaceState) != "undefined") {
       ...
       history.replaceState('<?php echo base_url();?>', '', '<?php echo base_url();?>'+url);
...
function showslugprofile(regionid,getprofileid){
  //alert(regionid);
...
$( regionid ).load( "<?php echo base_url();?>home/getslugregions?id="+rid+"&sno="+rcnt+"&profileid="+getprofileid, function() {});
}
}
function getUrlVars(){
    /*
...
showregion(regid);
  ...
  */
  ...
  var getprofileurl= '<?php echo $getprofile;?>';
 // var arr = vars.split('-');
   var arr_menu=['home','map','suggestion','haiti-banner','jamaica-banner','puertorico-banner','trinidadandtobago-banner','stats','about']
   
  if(getprofileurl !="")
  {
    var get_region=vars;
    var getprofile_id=getprofileurl;
    
      get_region="#"+get_region;
        //alert(get_region+" "+getprofile_id);
     showslugprofile(get_region,getprofile_id);
//alert(getregion+" "+getprofileid);
  Waypoint.disableAll();
//$.waypoints('disable');
 setTimeout(function(){
...
//$.waypoints('enable');
//alert(sthis);
var geturl = get_region+"-profile"

 var getproid=$(geturl).attr("data-proid");
//alert(getproid);
movetoprofile(geturl);
  ...
  {
            var returningval=$.inArray(vars,arr_menu);
            
             if(returningval==-1)
              {
                  Waypoint.disableAll()
                  setTimeout(function(){Waypoint.enableAll()}, 2000);
                      if(vars !="" && vars !='main_cato' && vars !='home' )
                      {
                            var regid = '#'+vars;
                            if(vars=="recentlyadded")
                            {
                                $('html,body').animate({scrollTop: $(regid).offset().top},100);
                            }else if(vars=="meme")
                            {
                                $('html,body').animate({scrollTop: $('#meme').offset().top},100); 
                            }
                             else
                             {
                                showregion_tmp(regid);
                                $('html,body').animate({scrollTop: $(regid).offset().top-90},100);
                             } 
                    }  
...
function showprofiletmp(regionid,getprofileid){
  //alert(regionid);
var rid = $(regionid).attr('data-id');
var rcnt = $(regionid).attr('data-cnt');
//alert(rid);
...
function redirectregion(strurl)
{
    //window.location.href=strurl;
//    alert(strurl);
   var regionids= '#'+strurl;
    showregion_tmp(regionids);
   Waypoint.disableAll()
setTimeout(function(){
Waypoint.enableAll()
}, 2000);
$('html,body').animate({scrollTop: $(regionids).offset().top-90},100);

    ChangeUrl(strurl); 
}
function showprofile(rid,loadid,selector,getpro)
{
...
if(loadid != 'anguillaold'){
showprofileafterSearch(rid,'#'+loadid,'.'+selector,getpro);    //  OLD CODE
// change
...
var aftersearchrcnt=10;
function showprofileafterSearch(rid,regionid,selector,getprofileid){ //alert("Testing");

 //alert(rid+" "+regionid+" "+selector+" "+getprofileid);

if(typeof(getprofileid)==='undefined')
{ getprofileid = 0; }
$( regionid ).load( "<?php echo base_url();?>home/getregions?id="+rid+"&sno="+aftersearchrcnt+"&profileid="+getprofileid,function(responseTxt,statusTxt,xhr){
});

Waypoint.disableAll();
//$.waypoints('disable');
 setTimeout(function(){
    Waypoint.enableAll(); }, 3000);

moveToSearchedProfile("#getsearchprofile_"+getprofileid);
aftersearchrcnt++;
}

function changecountrybg(getid)
{
    
     $("#top-menu .countrys").removeClass("countryschange");
   //$(this).css({ 'color': 'red'});
    $("#countrys_"+getid).addClass("countryschange");
}

$('.language-spanish').click(function(){
         $('.language-english').removeClass('notdisLang');
         $('.language-spanish').addClass('notdisLang');
});
$('.language-english').click(function(){
         $('.language-spanish').removeClass('notdisLang');
         $('.language-english').addClass('notdisLang');
});
$(document).ready(function () { //setTimeout(function(){

/*$('.language-english').addClass('');*/

    $('.countrys').click(function() {
   
    //$('.countrys').css("color","#fff");
     $("#top-menu .countrys").removeClass("countryschange");
   //$(this).css({ 'color': 'red'});
    $(this).addClass("countryschange");
     
     
    // alert(this.id);
  
     $('#memeb ').css({ 'color': '','background-color': ''});
...
var rid = $(regionid).attr('data-id');
var rcnt = $(regionid).attr('data-cnt');
var getregion = $(regionid).attr('id');
//alert(getregion);
if(typeof(getprofileid)==='undefined')
{ getprofileid = 0; }
...
$('#memeb').click(function() { 
    $("#top-menu .countrys").removeClass("countryschange");
    $('#memeb ').css({ 'color': '#0CF !important','background-color': '#666 !important','background-image': 'none !important' ,'background':'url(black_trans.png'});
 ChangeUrl("meme");
   
//$.waypoints('disable');
 $.waypoints('disable');
  setTimeout(function(){$.waypoints('enable');}, 2000);
  
  $('html,body').animate({scrollTop: $('#meme').offset().top-100},'fast');
  
  //$.waypoints('enable');
//setTimeout(function(){$.waypoints('enable');}, 1500);
});
...
$('.suggestionLink').click(function(){$('html,body').animate({scrollTop: $('#screen-3').offset().top},'fast'); 
    $("#top-menu .countrys").removeClass("countryschange");
    
    $('#memeb ').css({ 'color': '','background-color': ''});

$( "#screen-menu .suggestion" ).trigger( "click" );
 ChangeUrl("suggestion");
});
/*  map stat*/
$('.mapLink').click(function(){$('html,body').animate({scrollTop: $('#screen-2').offset().top},'fast'); 
    $("#top-menu .countrys").removeClass("countryschange");
    
    $('#memeb ').css({ 'color': '','background-color': ''});

$( "#screen-menu .map" ).trigger( "click" );
 ChangeUrl("map");
});

$('.statsLink').click(function(){$('html,body').animate({scrollTop: $('#screen-3').offset().top},'fast'); 
    $("#top-menu .countrys").removeClass("countryschange");
    
    $('#memeb ').css({ 'color': '','background-color': ''});

$( "#screen-menu .stats" ).trigger( "click" );
 ChangeUrl("stats");
});
/* map stud*/
...
/*  colse clanguage select   */

//*********************** FOR top menu ******************** 

 var showtopmenuwaypoint = new Waypoint({
  element: document.getElementById('top-menu'),
...
//********************************************************************
//*********************** FOR RECENT ADDED PROFILE ******************** 
 var showrecentaddedwaypoint = new Waypoint({
  element: document.getElementById('recentlyadded'),
  handler: function(direction) {
  //  alert("recentlyadded");
     ChangeUrl("recentlyadded");
    }
    ,offset: "0%"
});
//********************************************************************
//*********************** FOR ANGUILLA COUNTRY DETAIL ******************** 
 var showanguillawaypoint = new Waypoint({
  element: document.getElementById('showanguilla'),
  handler: function(direction) {
   // alert("showanguilla");
    ChangeUrl("anguilla");
     var getcountryid= $("#anguilla").attr('data-id');
    changecountrybg(getcountryid);
    },
   offset: "0%"
});
...
//********************************************************************
 ...
 var showrecentaddedwaypoint = new Waypoint({
  element: document.getElementById('main_cato'),
  handler: function(direction) {
...
//$.fn.waypoint.defaults = {context: window,continuous: false,enabled: false,horizontal: false,triggerOnce: true}
...
$( "#"+this.id ).waypoint(function(direction) {
    ...
    //$( "#"+this.id ).waypoint('refresh');
var getdivid ="#"+this.id;
//alert($(this).element.clientHeight);
//var getoffset=$("#"+this.id).offset().top + $(this).height();
//  alert($("#"+this.id).offset().top + $(this).height());
$("#"+this.id).css("border","4px solid #ccc");

//$("#"+this.id).text(getdivid +"    "+getoffset);
var divid =this.id;
//alert(this.element.clientHeight);
ChangeUrl(divid);
showregion(getdivid);
...
var getdivid =this.id;
  ...
  element: document.getElementById(getdivid),
  handler: function(direction) {
   
        
    var getdivids ="#"+getdivid;
    var getcountryid= $(getdivids).attr('data-id');
    changecountrybg(getcountryid);
    $('#memeb ').css({ 'color': ''});
        showregion(getdivids);
         waypoint.disable();
          waypoint.enable();
   ChangeUrl(getdivid);
  },
...
//*********************** FOR ANGUILLA COUNTRY DETAIL ******************** 
 var showmemewaypoint = new Waypoint({
  element: document.getElementById('meme'),
  handler: function(direction) {
   // alert("showanguilla");
    ChangeUrl("meme");
    $("#top-menu .countrys").removeClass("countryschange");
  $('#memeb ').css({ 'color': '#0CF !important'});
  $('#meme').addClass('countryschange')
   //  var getcountryid= $("#anguilla").attr('data-id');
    //changecountrybg(getcountryid);
    },
   offset: "bottom-in-view"
...
<!--<script> 
function googleTranslateElementInit() {
    new google.translate.TranslateElement({pageLanguage: 'en',includedLanguages : 'en,es', layout: google.translate.TranslateElement.InlineLayout.SIMPLE, autoDisplay: false}, 'showlang');
    //$('.goog-te-gadget-icon').css('display', 'none');
...
$flag = 0;
//alert("Test");
$(".autosearchprofile").on("click",function(){
...
$("#screen-9 li").on("click", function () {
        var e = $(this);
        if (!e.hasClass("selected")) {
            var t = e.attr("id").substring(5);
           // alert(t)
            $("#screen-9 .about-link").removeClass("selected"), e.addClass("selected"), $("#screen-9 .about-section").removeClass("selected").fadeOut(100), $("#section-" + t).addClass("selected").delay(100).fadeIn(300)
        }
    })
});
...
$(document).ready(function() {	
  /*  
  $('.search-ac').bind('click',function(event){
...
var getslug = $(dataid).attr('data-slug');
//alert(dataid+" "+regionid+" "+profile_title+" "+imgurl+" "+postid+" "+proid+" "+des);
...
$('html,body').animate({scrollTop: $('#'+postid+'-profile').offset().top-20},'slow');

setTimeout(function(){
//$.waypoints('enable');
//alert(sthis);
ChangeUrl(postid+"/"+getslug); // change
 //$('.countrys').css("color","#fff");
     $("#top-menu .countrys").removeClass("countryschange");
   //$(this).css({ 'color': 'red'});
    var getcountry_id = $("#"+postid).attr("data-id");
    $("#countrys_"+getcountry_id).addClass("countryschange");
    // alert(this.id);
    $('#memeb ').css({ 'color': ''});
...
//alert(getkind);
if(getkind=="funfacts")
{ $("#funfacts-"+postid).remove();
 var showfunfacts='<h4 class="heading funfacts" id="funfacts-'+postid+'">-Fun facts-</h4>';
...
//alert($('#'+postid+'-player').position().top-150)
