...
<p>
<?php if($banners5->background_img<>''){?>
<img class="flg lazy" src="<?php echo base_url()."library/upload/".$banners5->background_img;?>" width="200" height="120" style="margin-right:20px;" border="0" align="left">
<?php } ?>
...
.countryschange{color: #00CCFF !important;cursor: pointer !important; }
.countryschange > a{color: #00CCFF !important;cursor: pointer !important; }
.memecontent{display: block !important; }
.memecontent a{margin-top: 0px;font-family: cursive !important;display: block !important;color: white !important;text-decoration: none !important;font-size: 16px;}
...
showregion(regid);
  ...
  */
  ...
  if(arr.length==2)
  {
    var get_region=arr[0];
    var getprofile_id=arr[1];
    
      get_region="#"+get_region;
        //alert(get_region+" "+getprofile_id);
     showprofiletmp(get_region,getprofile_id);
