...
foreach($smalladRs as $objAdRow){
    ...
    {
   ?>
<li class="span_2"><a href="<?php echo SITE_MEDIA.$objAdRow->image;?>" rel="prettyPhoto[gallery2]" title="<?php echo $objAdRow->title;?>"><img src="<?php echo BASE_URL.'library/upload/'.$objAdRow->image;?>" width="200" height="150" class="lazy" alt="" /><div class="zoomtext"><i class="icon-search icon-2x" style="display: block;"></i><span>Zoom</span></div></a></li>
<?php }
}
	?>
</ul>
...
<img class="post-img lazy" alt="" src="<?php echo BASE_URL.'library/upload/'.$regionObject->flag;?>" width="300" height="180">
...
<?php $regimg = '<li> <img class="sm_image lazy" src="'.base_url().'library/upload/'.$regionObject->ragion_map.'"><p>'.stripslashes($regionName).'</p></li>'; ?>
