                ...
                <div class="cd-container">
                            <div class="islandParallax" id="home-<?php echo $_GET['sno'];?>" style="background: url(<?php echo $src;?>) 50% 0 fixed no-repeat;">
                                    ...
                                    foreach($smalladRs as $objAdRow){
                                        ...
                                        {
                                       ?>
                                      <li class="span_2"><a href="<?php echo SITE_MEDIA.$objAdRow->image;?>" rel="prettyPhoto[gallery2]" title="<?php  if(isset($objAdRow->website_link)){ echo " <a href=".$objAdRow->website_link." target='_blank'>".$objAdRow->short_des."</a>"; } ?>" ><img src="<?php echo BASE_URL.'library/upload/'.$objAdRow->image;?>"   link='<?php echo $objAdRow->website_link; ?>'  width="200" height="150" class="lazy" alt="" /><div class="zoomtext"><i class="icon-search icon-2x" style="display: block;"></i><span>Zoom</span></div></a></li>
                                    <?php }
                                    }
                                    	?>
                                    </ul>
