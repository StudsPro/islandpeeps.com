			 	...
			 	<!--<form id="advanced-form" class="form-horizontal"> -->
                    ...
                    <div class="panel-heading">
					 ...
					 <?php
                          ...
                          $hidden = array("id"=>$id);
                          $fromurl= $id >0 ? "admin/peopleprofile/edit/".$id : "admin/peopleprofile/create";
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
						    ...
						    <?php
                              ...
                              ?> 
                              <br>
                              <span style="color:#009100">Image dimension must be 1400 X 900.</span>
                              <?php 
                                 if(!empty($images_error) && isset($images_error["peopleprofile_error"]))
                                 {
                                  echo '<div class="col-md-7 red text-center">'.$images_error["peopleprofile_error"].'</div>';
                                 }
                                 ?>   
                          </div>
                              <?php
   ...
   $("#submitforready").on('click', function(){ 
        $.ajax({
                   ...
                   // dataType: 'JSON',
                    type: 'POST',
                    cache: false,
                    url:  '<?php echo base_url();?>admin/peopleprofile/changestatus',
                    data : {
                    strgetstatus : "3",
                    ...
                    window.location.href="<?php echo base_url();?>admin/peopleprofile";
 ...
 function removeimg(strflag,strgetid)
 {
    $.ajax({
                   ...
                   // dataType: 'JSON',
                    type: 'POST',
                    cache: false,
                    url:  '<?php echo base_url();?>admin/peopleprofile/deleteimage',
                    data : {
                    strflag : strflag,
                    strgetid : strgetid
                    },
