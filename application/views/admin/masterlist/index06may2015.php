              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  ...
                  <div class="col-lg-2 col-md-4 col-xs-6" >
				             <?php
                                    $kindgetclass="class='form-control input-md col-xs-offset-1' id='fillter' "; 
                  ...
                  <div class="col-lg-2 col-md-4 col-xs-4" >
				   ...
				   <a href="<?=SITE_ADMIN_URL;?>masterlist/bulkprofile" class="btn btn-info hidden-xs">
                      ...
                      <a href="<?=SITE_ADMIN_URL;?>masterlist/bulkprofile" alt="Bulk Profiles Add" title="Bulk Profiles Add" class="btn btn-info visible-xs col-xs-4 col-xs-offset-2">
                         <span class="fa fa-inbox"></span></a>   
                  </div>
                  <div class="col-lg-2 col-md-4 col-xs-4" >
				   <a href="<?=SITE_ADMIN_URL;?>masterlist/addcategory" class="btn btn-success hidden-xs">
                         ...
                         <a href="<?=SITE_ADMIN_URL;?>masterlist/addcategory" alt="Add new category" title="Add new category" class="btn btn-success  visible-xs col-xs-4 col-xs-offset-2">
                         <span class="fa fa-inbox"></span></a>
                  </div>
