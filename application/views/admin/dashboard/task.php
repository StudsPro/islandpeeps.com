<?php
$write=affilateright("dashboard","taskwrite");
$read=affilateright("dashboard","taskread");
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                 ...
                 ?> 
                  ...
                  <div class="col-md-2 "  >
				   <a href="<?=SITE_ADMIN_URL;?>dashboard/givetask" class="btn btn-info ">
                         <span class="fa fa-pencil"></span>Create Task</a>
                  </div>
                    <?php
                 }   
                    ?> 
