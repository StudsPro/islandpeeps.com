...
?>
	<div class="row-fluid">
		...
		<div class="btn-icon col-xs-6 col-sm-6 col-md-2 ">
		  <a class="btn btn-warning button_inbox" role="button" href="<?=SITE_ADMIN_URL;?>imailboxs"><i class="fa fa-inbox fa-lg"></i>
  ...
  ?>
  <style>
  .new_col6 > div:nth-child(2n+1) {  clear: both;}
.dashclass{    cursor: move;}
.remove-lpadding{ padding-left: 0px !important;}
  </style>
 <?php
				    ...
				    $recenthtml.='<div class="col-md-6">	
                      ...
                      <div class="row-fluid">';
					  	...
					  	if($login_user_sadmin == '1' || $objRow['status'] == '1' || ($this->session->userdata('uid') == $objRow['admin_id'] && $objRow['status'] == '2'))
							...
							$recenthtml.='<a href="'.SITE_ADMIN_URL.'masterlist/edit/'.$objRow['id'].'"  class="userprofilename"><span>'.$objRow['title'].'</span></a>';
   ...
   // $rside_dashboard["rrst"]=$rsthtml;
                      ...
                      <div class="chat-body clearfix">
                        <div class="header"><strong class="primary-font '. (($key%2 == 0 ) ? ' ' : 'pull-right').'">'.$objRow['username'].' </strong>
                          <small class="'.(($key%2 == 0 ) ? 'pull-right' : ' ').' text-muted">
                            <span class="fa fa-clock-o fa2"></span>';
    ...
    ?>
     <?php
                        ...
                        $rvistspercountry_html='<div class="col-md-12 dashclass span2" id="rvistspercountry">
              <div class="panel panel-primary panel_tracking ">
                <div class="panel-heading">
                ...
                <div class="panel-body maxheight_resouce remove-lpadding">
                  <div id="pie-visitsperc" style="height:500px" class="plot"></div>
                        ...
                        $rside_dashboard["rvistspercountry"]=$rvistspercountry_html;
                        
                        ?>
              <?php
                        
                       
                        $rprofilepercountry_html='<div class="col-md-12 dashclass span2" id="rprofilepercountry">
              <div class="panel panel-primary panel_tracking ">
                <div class="panel-heading">
                ...
                <div class="panel-body maxheight_resouce remove-lpadding" >
                  <div id="pie-profileperc" style="height:500px" class="plot"></div>
                        ...
                        $rside_dashboard["rprofilepercountry"]=$rprofilepercountry_html;
                        
                        ?>
              <?php
                        
                       
                        $rvisitperdate_html='<div class="col-md-6 dashclass span2" id="rvisitperdate">
              <div class="panel panel-primary panel_tracking ">
                <div class="panel-heading">
                ...
                <div class="panel-body maxheight_resouce">
                  <div id="demo-plot" style="height:500px" class="plot"></div>
                      ...
                      //  $rside_dashboard["rvisitperdate"]=$rvisitperdate_html;
                        
                        ?>                       
   
   <?php   // profileperc   demo-plot
            //  echo "<pre>";
            // print_r($module_arr);
             //exit;
            // if(empty($userleftmenus))
          //unset($userdashboardmenus);
...
// GRAPH            
var graph = new AmCharts.AmGraph();graph.valueField = "value1";
