			 	...
			 	<!--<form id="advanced-form" class="form-horizontal"> -->
                    ...
                    <div class="panel-heading">
					 ...
					 <?php
                          ...
                          $hidden = array("id"=>$id);
                          $fromurl= $id >0 ? "admin/suggestion/create/".$id : "admin/suggestion/create";
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
						    ...
						    <?php
                              ...
                              <?php 
                                 if(!empty($images_error) && isset($images_error["suggestion_error"]))
                                 {
                                  echo '<div class="col-md-7 red text-center">'.$images_error["suggestion_error"].'</div>';
                                 }
                                 ?>   
                          </div>
                              <?php
                          ...
                          <div class="control-group">OR</div>
						    ...
						    <?php
                             ...
                             <div class="form-group">
								<label for="title" class="col-md-2 control-label">Facebook fun page </label>
								<div class="col-md-5">
						    <?php
						    ...
						    <?php
                              ...
                              <div class="form-group">
								<label for="title" class="col-md-2 control-label"> Twitter fun page </label>
								<div class="col-md-5">
						    <?php
   ...
   $("#submitforready").on('click', function(){ 
        $.ajax({
                   ...
                   // dataType: 'JSON',
                    type: 'POST',
                    cache: false,
                    url:  '<?php echo base_url();?>admin/suggestion/changestatus',
                    data : {
                    strgetstatus : "3",
                    ...
                    window.location.href="<?php echo base_url();?>admin/suggestion";
 ...
 function removeimg(strflag,strgetid)
 {
    $.ajax({
                   ...
                   // dataType: 'JSON',
                    type: 'POST',
                    cache: false,
                    url:  '<?php echo base_url();?>admin/suggestion/deleteimage',
                    data : {
                    strflag : strflag,
                    strgetid : strgetid
                    },
