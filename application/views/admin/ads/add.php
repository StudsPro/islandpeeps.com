                         ...
                         <div class="form-group">
						    ...
						    <?php
                             ...
                             <?php echo form_error('title', '<div class="col-md-7 red text-center">', '</div>'); ?> 
                              ...
                              <div class="form-group">
								...
								<div class="col-md-5">
						    <?php
                               $data = array('name'=> 'shortdesc','id'=> 'shortdesc','value'=> set_value('title',$shortdesc),'class'=> 'form-control input-md');
                               echo form_input($data);
                              ?>      
                             </div>
                             <?php echo form_error('shortdesc', '<div class="col-md-7 red text-center">', '</div>'); ?> 
                                
                                </div>  
                                <div class="form-group">
								<label for="title" class="col-md-2 control-label">Website Link </label>
								<div class="col-md-5">
						    <?php
                               $data = array('name'=> 'websitelink','id'=> 'websitelink','value'=> set_value('title',$websitelink),'class'=> 'form-control input-md');
                               echo form_input($data);
                              ?>      
                             </div>
                             <?php echo form_error('websitelink', '<div class="col-md-7 red text-center">', '</div>'); ?> 
                          ...
                          <div class="form-group">
						    ...
						    <?php
                             ...
                             $arrvideo_value=array("mp4","flv","bat","mov"); 
                             $showid_arr=array(1,8);
                             if(in_array($ext,$arrvideo_value) && !in_array($id,$showid_arr) )
                             {  
                               if(!empty($image) && file_exists(SITE_UPLOADPATH.$image) )
                               {  
                                 $image=trim($image);
                                ...
                                <div class="col-md-3 text-center  " id="raggionmapimg">
                                  <div id="showvideos">Loading the player...</div>  
							
							<script type="text/javascript">
								jwplayer("showvideos").setup({
