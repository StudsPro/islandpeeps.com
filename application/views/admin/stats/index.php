                  ...
                  <!--Block-->
                       ...
                       <?php
                        ...
                        ?> 
                         ...
                         $statsyearlywiseinfo_html='<div class="col-md-6 span2" id="statsyearlywiseinfo">
                                    <div class="panel panel-primary ">
                                <div class="panel-heading">
                        ...
                        $mlist_stats["statsyearlywiseinfo"]=$statsyearlywiseinfo_html;
                        
                        ?> 
                         <?php
                        
                         $statsmonthlywiseinfo_html='<div class="col-md-6 span2" id="statsmonthlywiseinfo">
                                    <div class="panel panel-primary ">
                                <div class="panel-heading">
                                  <div class="panel-title"> Month ('.date("M").') Hits</div>
                                </div>
                                <div class="panel-body maxheight">
                        ...
                        $mlist_stats["statsmonthlywiseinfo"]=$statsmonthlywiseinfo_html;
                        
                        ?> 
                        <?php
                        
                         $statsdaywiseinfo_html='<div class="col-md-6 span2" id="statsdaywiseinfo">
                                    <div class="panel panel-primary ">
                                <div class="panel-heading">
                        ...
                        $mlist_stats["statsdaywiseinfo"]=$statsdaywiseinfo_html;
    ...
    <script src="<?=ADMIN_THEEM_JS?>amcharts/amcharts.js"></script>
 	<script type="text/javascript">
		...
		var chartDataPageTrack = [<?=rtrim($pagetrackingviews,',')?>];
 	    ...
 	    var yearlypageviewsChart = '<?= $yearlypageviews ? 'yes' : ''?>';
		var chartDatayearlypageviews = [<?=rtrim($yearlypageviews,',')?>];
        
        var monthlypageviewsChart = '<?= $monthlypageviews ? 'yes' : ''?>';
		var chartDatamonthlypageviews = [<?=rtrim($monthlypageviews,',')?>];
        
         var dayspageviewsChart = '<?= $daypageviews ? 'yes' : ''?>';
		var chartDatadayspageviews = [<?=rtrim($daypageviews,',')?>];
        
        	if(dayspageviewsChart){
             	  	AmCharts.ready(function () {  
			var	countrypie = new AmCharts.AmPieChart();
				countrypie.dataProvider = chartDatadayspageviews;
			...
			var	countrylegend = new AmCharts.AmLegend();
				...
				// WRITE
				countrypie.write("piedaysdiv");
                
               }); 
			} 
        
          	if(monthlypageviewsChart){
             	  	AmCharts.ready(function () {  
			var	countrypie = new AmCharts.AmPieChart();
				countrypie.dataProvider = chartDatamonthlypageviews;
				countrypie.titleField = "label";
				countrypie.valueField = "data";
				countrypie.outlineColor = "#FFFFFF";
				countrypie.outlineAlpha = 0.8;
			...
			var	countrylegend = new AmCharts.AmLegend();
          	...
          	if(yearlypageviewsChart){
             	  	AmCharts.ready(function () {  
			var	countrypie = new AmCharts.AmPieChart();
				countrypie.dataProvider = chartDatayearlypageviews;
				countrypie.titleField = "label";
				countrypie.valueField = "data";
				countrypie.outlineColor = "#FFFFFF";
				countrypie.outlineAlpha = 0.8;
			...
			var	countrylegend = new AmCharts.AmLegend();
				...
				countrypie.addLegend(countrylegend);
				// WRITE
				countrypie.write("pie-yearlydiv");
