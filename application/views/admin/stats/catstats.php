                      ...
                      <?php
                       ...
                       <?php
                        ...
                        ?>
                         ...
                         $mlistsuggestionpercountry_html='<div class="row span2" id="mlistsuggestionpercountry">
                              	<div class="col-md-12">
                                          <div class="panel panel-primary  ">
                                            <div class="panel-heading ">
                                            ...
                                            <div class="panel-body propercmaxheight">
                                               <div class="col-md-12">
                                                <div id="pie-suggestion" class="plot" style="height:600px"></div>
                                               </div> 
                                           </div>
                                          </div>
                                  </div>  
                        ...
                        $mlist_stats["mlistsuggestionpercountry"]=$mlistsuggestionpercountry_html;
                       ...
                       $mlistsuggestionkind_html='<div class="row span2" id="mlistsuggestionkind">
                              	<div class="col-md-12">
                                          <div class="panel panel-primary  ">
                                            <div class="panel-heading ">
                                            ...
                                            <div class="panel-body maxheight">
                                               <div class="col-md-12">
                                                <div id="pie-suggestionkind" class="plot" style="height:300px"></div>
                                               </div> 
                        ...
                        $mlist_stats["mlistsuggestionkind"]=$mlistsuggestionkind_html;  
                        
                         $mlistsuggestiontopemail_html='<div class="row span2" id="mlistsuggestiontopemail">
                              	<div class="col-md-12">
                                          <div class="panel panel-primary  ">
                                            <div class="panel-heading ">
                                            ...
                                            <div class="panel-body maxheight">
                                               <div class="col-md-12">
                                                <div id="pie-suggestiontopemail" class="plot" style="height:300px"></div>
                                               </div> 
                        ...
                        $mlist_stats["mlistsuggestiontopemail"]=$mlistsuggestiontopemail_html;  
                        ?>  
                       <?php
                            // unset($usermasterliststats);
                            if($read==true)
                       {  
                       ...
                       //echo $mlistsuggestiontopemail_html;
                       ?>
    ...
    window.location.href="<?php echo base_url();?>admin/mliststats/index/"+this.value;
		...
		var pieDataAuthors = [<?= rtrim($Authors,',')?>];
         ...
         var pieDataprofilebob = [<?= rtrim($profilebob,',')?>]; 
               ...
               var suggestionkindsadminChart = '<?= $suggestionkinds ? 'yes' : ''?>';
         var pieDatasuggestionkinds = [<?= rtrim($suggestionkinds,',')?>]; 
           
            var suggestionpercountryadminChart = '<?= $suggestionpercountry ? 'yes' : ''?>';
         var pieDatasuggestionpercountry = [<?= rtrim($suggestionpercountry,',')?>]; 
           
            var suggestiontopemailadminChart = '<?= $suggestiontopemail ? 'yes' : ''?>';
         var pieDatasuggestiontopemail = [<?= rtrim($suggestiontopemail,',')?>];
           
           if(suggestiontopemailadminChart){
            	 json = pieDatasuggestiontopemail;
//			AmCharts.ready(function() {
    // SERIAL CHART
chart = new AmCharts.AmSerialChart();
chart.dataProvider = json;chart.categoryField = "label";chart.marginRight = 0;chart.marginTop = 0; 
...
// GRAPH            
var graph = new AmCharts.AmGraph();graph.valueField = "data";
graph.colorField = "color";
graph.balloonText = "[[category]]: [[value]]";graph.type = "column";graph.lineAlpha = 0;graph.fillAlphas = 1;
chart.addGraph(graph);
// WRITE
chart.write("pie-suggestiontopemail");    
                
			}
           
           
            if(suggestionpercountryadminChart){
           json = pieDatasuggestionpercountry;
                //			AmCharts.ready(function() {
                    // SERIAL CHART
                chart = new AmCharts.AmSerialChart();
          ...
          if(suggestionkindsadminChart){
            	  AmCharts.ready(function () {   
			var	upie = new AmCharts.AmPieChart();
				upie.dataProvider = pieDatasuggestionkinds;
...
chart.addGraph(graph);
// WRITE
chart.write("pie-profilebyadmin");    
...
chart.addGraph(graph);
// WRITE
chart.write("pie-singer");    
                
                
			}
            
            if(AthletesChart){
             json = pieDataAthletes;
//			AmCharts.ready(function() {
    // SERIAL CHART
chart = new AmCharts.AmSerialChart();
chart.dataProvider = json;chart.categoryField = "label";chart.marginRight = 0;chart.marginTop = 0; 
...
chart.addGraph(graph);
// WRITE
chart.write("pie-actors"); 
                
			}
             if(PoliticiansChart){
            	 json = pieDataPoliticians;
//			AmCharts.ready(function() {
    // SERIAL CHART
chart = new AmCharts.AmSerialChart();
chart.dataProvider = json;chart.categoryField = "label";chart.marginRight = 0;chart.marginTop = 0; 
