...
<style>
.funfacts {color: rgb(223, 69, 47);font-size: 2em !important;font-weight: normal !important; display: block; }
...
<div class="screen map" id="screen-2" style="background-color:#40a4df; margin-top:0px;">
<div> <a  class="gotopage scroll-link my-button btt red">Click island to go to page &#9654;</a>
...
<div class="screen" id="screen-4" data-video="<?php echo base_url()."library/upload/".$path_partsIntro3['filename'];?>"> 
...
<div class="screen" id="screen-5" data-video="<?php echo base_url()."library/upload/".$path_partsIntro4['filename'];?>"> 
...
<div class="screen" id="screen-6"  data-video="<?php echo base_url()."library/upload/".$path_partsIntro5['filename'];?>"> 
...
<div class="screen" id="screen-7" data-video="<?php echo base_url()."library/upload/".$path_partsIntro6['filename'];?>"> 
...
$path_partsIntro2 = @pathinfo("library/upload/".$banners6->background);
$sliderImgScreen2 = @pathinfo("library/upload/".$banners6->background_img);?>
<div class="screen" id="screen-9" data-video="<?php echo base_url()."library/upload/".$path_partsIntro2['filename'];?>"> 
<img class="big-image lazy" src="<?php echo  base_url()."library/upload/".$sliderImgScreen2['basename'];?>" width="100%" style="margin-right:20px;" border="0" align="left">
<div>
<div class="span_1 col clearfix " style="margin-right:9%;"> </div>
<div class="span_4 col clearfix blcc_txt" style="margin-right:3%; ">
...
<style>.scrmenu{color: #FFF;  display: block;  z-index: 999;  text-indent: initial;  color: #fff;  font-size: 17px;  bottom: 0;font-family:arial; font-weight:bold; }
...
.menutext .menu-tab .menu-logo {background-size: 100px 100px !important;}
.menutext .menu-tab .about {background-size: 100px 100px !important;}
.menutext .menu-tab .suggestion {background-size: 100px 100px !important;}
.menutext .menu-tab .map {background-size: 100px 100px !important;}
.menutext .menu-tab .ats {background-size: 100px 100px !important;}
.menutext .menu-tab .cps {background-size: 100px 100px !important;}
.menutext .menu-tab .perspectives {background-size: 100px 100px !important;}
.menutext .menu-tab .profiles {background-size: 100px 100px !important;}
.menutext .menu-tab .diaspora {background-size: 100px 100px !important;}  
 </style>
...
<ul role="navigation">
<li class="menu-tab selected"> <a role="tab" class="intro menu-logo menutext" href="#"><span class=" scrmenu">HOME</span></a> </li>
<li class="menu-tab"> <a role="tab" class="map menu-link"><span class=" scrmenu">MAP</span></a> </li>
<li class="menu-tab"> <a role="tab" class="suggestion menu-link" href="#getshowsuggestion"><span class=" scrmenu">SUGGESTION</span></a> </li>
<li class="menu-tab"> <a role="tab" class="ats menu-link" href="#haiti"><span class=" scrmenu">HAITI</span></a> </li>
<li class="menu-tab"> <a role="tab" class="cps menu-link" href="#jamaica"><span class=" scrmenu">JAMAICA</span></a> </li>
<li class="menu-tab"> <a role="tab" class="perspectives menu-link" href="#puertorico"><span class=" scrmenu">PUERTO RICO</span></a> </li>
<li class="menu-tab"> <a role="tab" class="profiles menu-link" href="#trinidadandtobago"><span class=" scrmenu">TRINIDAD</span></a> </li>
<li class="menu-tab"> <a role="tab" class="diaspora menu-link" href="#diaspora"><span class=" scrmenu">STATS</span></a> </li>
<li class="menu-tab "> <a role="tab" class="about menu-link"><span class=" scrmenu">ABOUT</span></a></li>
</ul>
</nav>
...
#top-menu ul li {   float: left; width: 16%;}
...
.customtop ul li {width:auto !important;font-size: 12px;text-align: left !important;}
.countrys{display:block !important;color: #fff !important;cursor: pointer !important; }
...
.countryschange{color: #00CCFF !important;cursor: pointer !important; background-color: #666 !important;background-image: none !important; background:url(black_trans.png);}
...
.memecontent a{margin-top: 0px;font-family: arial !important; font-weight: bold !important; display: block !important;color: white !important;text-decoration: none !important;font-size: 16px;}
       ...
       $i++; 
        ...
        foreach($key as $val)
         {  
            ...
            ?> <li class="countrys" id="countrys_<?php echo $val->id;?>"   onclick="redirectregion('<?php echo $siteurl;?>')"><?php echo $val->region_name;?></li> <?php
...
<div class="" id="meme"><?php include("memePage.php");?></div>
...
var getdivid =this.id;
 ...
 continuous: false,
 function () {
                return $("#"+this.id).offset().top + $(this).height();
            }
...
/*
$('.aftrlod').each(function() {
$( "#"+this.id ).waypoint(function (event, direction) {
             var getdivid ="#"+this.id;
//alert(divid);
                var divid =this.id;
                alert(divid);
