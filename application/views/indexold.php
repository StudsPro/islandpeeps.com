...
if(!empty($linkUsFormText)){ echo stripslashes(html_entity_decode($rowAbout->detailed_description, ENT_QUOTES));}else{?>
...
<h1 class="photo_name_white"><?php echo html_entity_decode($profileRow->shortdesc, ENT_QUOTES);?></h1>
</div>
</a>
<?php } ?>
</div>
