...
class Catmasterlist extends CI_Controller   
{   
    ...
    function __construct()
        {
            ...
            $this->load->model("catmasterlist_model");
    ...
    {      
      ...
      //   admin_lists
          ...
          $datas['breadcrumds']       = $breadcrumds;
           ...
           $editdata=$this->catmasterlist_model->GetpeopleprofileById($id);
         
           $regions_arr= $this->catmasterlist_model->GetAllRegion();
            $datas['regions_arr']=$regions_arr;
             $Categorys_arr= $this->catmasterlist_model->GetAllCategory();
   ...
   function index($getid="")
	   { 
           ...
           if($this->input->post("btn_delete"))
            { 
                if($this->input->post("selected"))
                {
                   ...
                   if(!empty($selected))
                   {
                       $this->catmasterlist_model->deleterecords($selected);
            ...
            { 
                if($this->input->post("selected"))
                {
                   ...
                   if(!empty($selected))
                   {
                       $this->catmasterlist_model->changeselectstatus($selected,'1');
            ...
            { 
                if($this->input->post("selected"))
                {
                   ...
                   if(!empty($selected))
                   {
                       $this->catmasterlist_model->changeselectstatus($selected,'2');
            ...
            { 
                if($this->input->post("selected"))
                {
                   ...
                   if(!empty($selected))
                   {
                       $this->catmasterlist_model->changeselectstatus($selected,'3');
            ...
            { 
                if($this->input->post("selected"))
                {
                   ...
                   if(!empty($selected))
                   {
                       $this->catmasterlist_model->changeselectstatus($selected,'4');
        ...
        //***********************************************************
         ...
         {
             $data['fillter'] ="Activist";
             $filter["fillter"]="Activist";
         }
        
         // $data['results'] = $this->catmasterlist_model->GetAllrecords($serachdata,$limit,$start);
           $regions_arr= $this->catmasterlist_model->GetAllRegion();
           $data['regions_arr']=$regions_arr;
            $category_arr= $this->catmasterlist_model->GetAllCategory($filter);
           $data['category_arr']=$category_arr;
          $data['results'] = $this->catmasterlist_model->GetAllrecords($filter); 
    ...
    function downloadpdf($getid="")
    {
      ...
      $results = $this->catmasterlist_model->GetAllrecords($filter); 
       $regions_arr= $this->catmasterlist_model->GetAllRegion();
	// Column headings
   ...
   //echo '<pre>';print_r($data);exit;
	...
	$config = array(
       ...
       { 
		...
		if ($this->form_validation->run() == TRUE)
		{
           ...
           $masterlistid=$this->catmasterlist_model->getmaxid("id","tbl_profiles");
            ...
            //******************************************************************** 
                    ...
                    { 
                            ...
                            $this->catmasterlist_model->insert($data);
	...
	$config = array(
		...
		if ($this->form_validation->run() == TRUE)
		{
            ...
            //******************************************************************** 
                     $this->catmasterlist_model->bulkprofileinsert($this->input->post());
	...
	$config = array(
		...
		if ($this->form_validation->run() == TRUE)
		{
		    ...
		    //******************************************************************** 
                            $this->catmasterlist_model->categoryinsert($this->input->post());
      ...
      //   admin_lists
           ...
           $datas['breadcrumds']       = $breadcrumds;
		   $datas['results']     = array();
          $datas['maxid']= $this->catmasterlist_model->getmaxid("id","tbl_category");
           $datas['images_error']= $images_error;
         $Categorys_arr= $this->catmasterlist_model->GetAllCategoryids();
           $datas['categorys_arr']=$Categorys_arr; 
...
$config = array(
 ...
 if(affilateright("masterlist","write")==true)
          ...
          // print_r($_FILES);
            ...
            if(empty($images_error))
                    { 
                            ...
                            $data["peopleprofile_image"]= $region_image_img_name;  
                            $this->catmasterlist_model->update($data);
	...
	{
		if ($this->catmasterlist_model->check_name($str) > 0)
		{
	...
	{
		if ($this->catmasterlist_model->editcheck_name($this->input->post("id"),$str) > 0)
		{
   ...
   public function title_check($str)
	{
		if ($this->catmasterlist_model->check_title($str) > 0)
		{
	...
	{
		if ($this->catmasterlist_model->editcheck_title($this->input->post("id"),$str) > 0)
		{
	...
	private function openView($xdata,$viewName)
	{
		...
		$this->load->view('admin/catmasterlist/'.$viewName,$xdata);
    ...
    public function deleteimage()
    {
       ...
       $editdata=$this->catmasterlist_model->GetpeopleprofileById($strgetid);
       ...
       $success="Y";
            ...
            if(!empty($getimagename) && file_exists(SITE_UPLOADPATH.$getimagename) )
            {
              ...
              $this->catmasterlist_model->updateimage($strgetid,"image");
            }else
            {
             $success="N";         
            }                    
   ...
   public function changestatus() 
    {
        ...
        $strstatus=$this->input->post("strgetstatus");
         ...
         $this->catmasterlist_model->changestatus($strgetid,$strstatus); 
    ...
    public function setbackgroundimage()
    {
          ...
          $this->catmasterlist_model->setbackgroundimage($editid); 
    } 
