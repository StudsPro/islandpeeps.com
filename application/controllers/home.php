...
class Home extends CI_Controller {
        ...
        public function home($slug="",$getprofile="")
        {  
            $data=array();  
           $data["page"]="Home"; 
           $data["sulg"]=$slug;
      ...
      public function index3($slug="")
        ...
        /* Changes are made by sharad which need to remove*/
      function getdata($id="")
    {
         $serachdata=array();
    ...
    public function getregionlist($slug="")
     {
           $data=array();  
           $data["page"]="Home"; 
             $data["sulg"]=$slug; 
      ...
      public function getslugregions()
        {  
            $data=array();  
           $data["page"]="Home";
           $data["id"]=$_REQUEST["id"];
           $data["sno"]=$_REQUEST["sno"];
            $data["profileid"]=$_REQUEST["profileid"];  
            
           $this->load->view('regionslug',$data);
           //$this->load->view('pages/home',$data);
          //$this->load->view('footer');
        } 
