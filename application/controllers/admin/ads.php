    ...
    if(affilateright("ads","write")==true )
       { 
		...
		if ($this->form_validation->run() == TRUE)
		{
           ...
           $data["websitelink"]=$this->input->post("websitelink");
                ...
                if(!empty($_FILES["image"]['name']))
					{
                       ...
                       // echo "<pre>";print_r($uploadConst);exit;
    ...
    if(affilateright("ads","write")==true)
      ...
      //   admin_lists
       ...
       //  echo"<pre>";print_r($editdata);exit;
         ...
         elseif (!empty($editdata)) {
			$datas['shortdesc'] = $editdata[0]["short_des"];
		 } 
         else{ $datas['shortdesc']= ""; }
         
         if($this->input->post("websitelink"))
         { $datas['websitelink']= $this->input->post("websitelink"); }
         elseif (!empty($editdata)) {
			$datas['websitelink'] = $editdata[0]["website_link"];
		 } 
         else{ $datas['websitelink']= ""; }
